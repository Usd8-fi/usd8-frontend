import{B as e,E as t,P as n,S as r,l as i,r as a}from"./ApiController-DWA16WV7.js";import{_ as o,b as s,c,g as l,h as u,o as d,p as f,u as p,v as m}from"./wui-text-7EwTqPDT.js";import{t as h}from"./ExchangeController-CODSUaqa.js";import"./wui-button-1hK_JKc-.js";import"./wui-icon-DQgkzRr-.js";import"./wui-icon-link-Cz0vUGsZ.js";import"./wui-image-Cc5kx629.js";import"./wui-image-BsTMaRYV.js";import"./wui-list-item-B4dQaeD3.js";import"./wui-separator-Chmnz9ei.js";import"./wui-shimmer-BXAOW0LB.js";import"./wui-link-S0P8t7x4.js";import"./wui-icon-box-BvoNYK9Z.js";import"./wui-list-token-CPlq6lQK.js";import"./wui-input-text-By5dqCKy.js";import"./wui-input-amount-Thij23qN.js";var g=f`
  button {
    border: none;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},A=class extends m{constructor(){super(),this.unsubscribe=[],this.assets=h.state.assets,this.search=``,this.onDebouncedSearch=e.debounce(e=>{this.search=e}),this.unsubscribe.push(h.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}onBuyClick(){r.push(`OnRampProviders`)}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){h.setPaymentAsset(e),r.goBack()}};A.styles=O,k([l()],A.prototype,`assets`,void 0),k([l()],A.prototype,`search`,void 0),A=k([d(`w3m-deposit-from-exchange-select-asset-view`)],A);export{A as W3mDepositFromExchangeSelectAssetView,D as W3mDepositFromExchangeView};