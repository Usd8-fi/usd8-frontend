import{A as e,C as t,E as n,S as r,T as i,_ as a,j as o,l as s,r as c,s as l,t as u,v as ee,y as d}from"./ModalController-BY3empUm.js";import{r as f}from"./wui-list-wallet-BPEXG0ua.js";import{t as te}from"./SwapController-B7PwAsmZ.js";import{t as p}from"./AlertController-DjH9TIUk.js";import"./w3m-tooltip-CYm0AImB.js";import{C as ne,_ as m,b as h,c as g,d as re,f as ie,g as _,l as v,o as y,p as b,s as x,u as S,v as C}from"./wui-text-eywEzzew.js";import"./wui-image-CTBYdb5V.js";import"./wui-loading-spinner-D-q_Mctj.js";import"./wui-icon-box-B9JPdH1r.js";import"./wui-icon-Cib79jYh.js";import{t as w}from"./ConstantsUtil-C1qdKpER.js";import{t as T}from"./wui-tag-Ch724xOi.js";import"./wui-button-DY83HOKP.js";import{n as E}from"./exports-C5azKG6g.js";var D={isUnsupportedChainView(){return d.state.view===`UnsupportedChain`||d.state.view===`SwitchNetwork`&&d.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){u.shake();return}if(await f.isSIWXCloseDisabled()){u.shake();return}(d.state.view===`DataCapture`||d.state.view===`DataCaptureOtpConfirm`)&&s.disconnect(),u.close()}},ae=_`
  :host {
    display: block;
...
`,L=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ge=[`SmartSessionList`],_e={PayWithExchange:m.tokens.theme.foregroundPrimary};function R(){let e=d.state.data?.connector?.name,t=d.state.data?.wallet?.name,n=d.state.data?.network?.name,r=t??e,i=a.getConnectors(),o=i.length===1&&i[0]?.id===`w3m-email`,s=c.getAccountData()?.socialProvider,l=s?s.charAt(0).toUpperCase()+s.slice(1):`Connect Social`;return{Connect:`Connect ${o?`Email`:``} Wallet`,Create:`Create Wallet`,ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:`All Wallets`,ApproveTransaction:`Approve Transaction`,BuyInProgress:`Buy`,UsageExceeded:`Usage Exceeded`,ConnectingExternal:r??`Connect Wallet`,ConnectingWalletConnect:r??`WalletConnect`,ConnectingWalletConnectBasic:`WalletConnect`,ConnectingSiwe:`Sign In`,Convert:`Convert`,ConvertSelectToken:`Select token`,ConvertPreview:`Preview Convert`,Downloads:r?`Get ${r}`:`Downloads`,EmailLogin:`Email Login`,EmailVerifyOtp:`Confirm Email`,EmailVerifyDevice:`Register Device`,GetWallet:`Get a Wallet`,Networks:`Choose Network`,OnRampProviders:`Choose Provider`,OnRampActivity:`Activity`,OnRampTokenSelect:`Select Token`,OnRampFiatSelect:`Select Currency`,Pay:`How you pay`,ProfileWallets:`Wallets`,SwitchNetwork:n??`Switch Network`,Transactions:`Activity`,UnsupportedChain:`Switch Network`,UpgradeEmailWallet:`Upgrade Your Wallet`,UpdateEmailWallet:`Edit Email`,UpdateEmailPrimaryOtp:`Confirm Current Email`,UpdateEmailSecondaryOtp:`Confirm New Email`,WhatIsABuy:`What is Buy?`,RegisterAccountName:`Choose Name`,RegisterAccountNameSuccess:``,WalletReceive:`Receive`,WalletCompatibleNetworks:`Compatible Networks`,Swap:`Swap`,SwapSelectToken:`Select Token`,SwapPreview:`Preview Swap`,WalletSend:`Send`,WalletSendPreview:`Review Send`,WalletSendSelectToken:`Select Token`,WalletSendConfirmed:`Confirmed`,WhatIsANetwork:`What is a network?`,WhatIsAWallet:`What is a Wallet?`,ConnectWallets:`Connect Wallet`,ConnectSocials:`All Socials`,ConnectingSocial:l,ConnectingMultiChain:`Select Chain`,ConnectingFarcaster:`Farcaster`,SwitchActiveChain:`Switch Chain`,SmartSessionCreated:void 0,SmartSessionList:`Smart Sessions`,SIWXSignMessage:`Sign In`,PayLoading:`Processing payment...`,PayQuote:`Payment Quote`,DataCapture:`Profile`,DataCaptureOtpConfirm:`Confirm Email`,FundWallet:`Fund Wallet`,PayWithExchange:`Deposit from Exchange`,PayWithExchangeSelectAsset:`Select Asset`,SmartAccountSettings:`Smart Account Settings`}}var z=class extends C{constructor(){super(),this.unsubscribe=[],this.heading=R()[d.state.view],this.network=c.state.activeCaipNetwork,this.networkImage=i.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=d.state.view,this.viewDirection=``,this.unsubscribe.push(n.subscribeNetworkImages(()=>{this.networkImage=i.getNetworkImage(this.network)}),d.subscribeKey(`view`,e=>{setTimeout(()=>{this.view=e,this.heading=R()[e]},w.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),c.subscribeKey(`activeCaipNetwork`,e=>{this.network=e,this.networkImage=i.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=_e[d.state.view]??m.tokens.theme.backgroundPrimary;return this.style.setProperty(`--local-header-background-color`,e),h`
    ...
    `}onWalletHelp(){t.sendEvent({type:`track`,event:`CLICK_WALLET_HELP`}),d.push(`WhatIsAWallet`)}async onClose(){await D.safeClose()}rightHeaderTemplate(){let e=o?.state?.features?.smartSessions;return d.state.view!==`Account`||!e?this.closeButtonTemplate():h`<wui-flex>
      <wui-icon-button
        icon="clock"
        size="lg"
        iconSize="lg"
    ...
    `}leftHeaderTemplate(){let{view:e}=d.state,t=e===`Connect`,n=o.state.enableEmbedded,r=e===`ApproveTransaction`,i=e===`ConnectingSiwe`,a=e===`Account`,s=o.state.enableNetworkSwitch,c=r||i||t&&n;return a&&s?h`<wui-select
        id="dynamic"
...
`,H=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},U=class extends C{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=e.state.open,this.unsubscribe.push(e.subscribeKey(`open`,e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){let{message:t,variant:n}=e.state;return h` <wui-snackbar message=${t} variant=${n}></wui-snackbar> `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:`translateX(-50%) scale(0.85)`},{opacity:1,transform:`translateX(-50%) scale(1)`}],{duration:150,fill:`forwards`,easing:`ease`}),this.timeout&&clearTimeout(this.timeout),e.state.autoClose&&(this.timeout=setTimeout(()=>e.hide(),2500))):this.animate([{opacity:1,transform:`translateX(-50%) scale(1)`},{opacity:0,transform:`translateX(-50%) scale(0.85)`}],{duration:150,fill:`forwards`,easing:`ease`})}};U.styles=ye,H([x()],U.prototype,`open`,void 0),U=H([v(`w3m-snackbar`)],U);var be=_`
  :host {
...
`,W=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=`scroll-lock`,xe={PayWithExchange:`0`,PayWithExchangeSelectAsset:`0`,Pay:`0`,PayQuote:`0`,PayLoading:`0`},K=class extends C{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=o.state.enableEmbedded,this.open=u.state.open,this.caipAddress=c.state.activeCaipAddress,this.caipNetwork=c.state.activeCaipNetwork,this.shake=u.state.shake,this.filterByNamespace=a.state.filterByNamespace,this.padding=m.spacing[1],this.mobileFullScreen=o.state.enableMobileFullScreen,this.initializeTheming(),r.prefetchAnalyticsConfig(),this.unsubscribe.push(u.subscribeKey(`open`,e=>e?this.onOpen():this.onClose()),u.subscribeKey(`shake`,e=>this.shake=e),c.subscribeKey(`activeCaipNetwork`,e=>this.onNewNetwork(e)),c.subscribeKey(`activeCaipAddress`,e=>this.onNewAddress(e)),o.subscribeKey(`enableEmbedded`,e=>this.enableEmbedded=e),a.subscribeKey(`filterByNamespace`,e=>{this.filterByNamespace!==e&&!c.getAccountData(e)?.caipAddress&&(r.fetchRecommendedWallets(),this.filterByNamespace=e)}),d.subscribeKey(`view`,()=>{this.dataset.border=T.hasFooter()?`true`:`false`,this.padding=xe[d.state.view]??m.spacing[1]}))}firstUpdated(){if(this.dataset.border=T.hasFooter()?`true`:`false`,this.mobileFullScreen&&this.setAttribute(`data-mobile-fullscreen`,`true`),this.caipAddress){if(this.enableEmbedded){u.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.setProperty(`--local-modal-padding`,this.padding),this.enableEmbedded?h`${this.contentTemplate()}
