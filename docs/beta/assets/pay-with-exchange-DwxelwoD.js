import{A as e,B as t,T as n,l as r,r as i,y as a}from"./ModalController-BY3empUm.js";import{t as o}from"./ExchangeController-Cu7efoNn.js";import{b as s,c,d as l,g as u,l as d,o as f,p,s as m,v as h}from"./wui-text-eywEzzew.js";import"./wui-image-CTBYdb5V.js";import"./wui-icon-Cib79jYh.js";import"./wui-link-CcMAS7cd.js";import"./wui-icon-link-CcsT0vRq.js";import"./wui-list-item-DEQ0a_AA.js";import"./wui-button-DY83HOKP.js";import"./wui-icon-box-CTz_gVo4.js";import"./wui-list-token-3-3OhUsy.js";import"./wui-separator-Cij_VsJk.js";import"./wui-shimmer-9JKaAnLE.js";import"./wui-input-text-CHy4qJjN.js";import"./wui-image-Be0GLizg.js";import"./wui-input-amount-Bgo9k-C4.js";var g=u`
  button {
    border: none;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},A=class extends h{constructor(){super(),this.unsubscribe=[],this.assets=o.state.assets,this.search=``,this.onDebouncedSearch=t.debounce(e=>{this.search=e}),this.unsubscribe.push(o.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}onBuyClick(){a.push(`OnRampProviders`)}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){o.setPaymentAsset(e),a.goBack()}};A.styles=O,k([m()],A.prototype,`assets`,void 0),k([m()],A.prototype,`search`,void 0),A=k([d(`w3m-deposit-from-exchange-select-asset-view`)],A);export{A as W3mDepositFromExchangeSelectAssetView,D as W3mDepositFromExchangeView};