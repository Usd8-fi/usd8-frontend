...
`,$e=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},et=class extends I{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.network=b.state.activeCaipNetwork,this.networkImage=h.getNetworkImage(this.network),this.caipAddress=b.state.activeCaipAddress,this.loading=x.state.loading,this.isSupported=_.state.allowUnsupportedChain?!0:!b.state.activeChain||b.checkIfSupportedNetwork(b.state.activeChain),this.unsubscribe.push(f.subscribeNetworkImages(()=>{this.networkImage=h.getNetworkImage(this.network)}),b.subscribeKey(`activeCaipAddress`,e=>{this.caipAddress=e}),b.subscribeKey(`activeCaipNetwork`,e=>{this.network=e,this.networkImage=h.getNetworkImage(e),this.isSupported=!e?.chainNamespace||b.checkIfSupportedNetwork(e.chainNamespace),h.fetchNetworkImage(e?.assets?.imageId)}),x.subscribeKey(`loading`,e=>this.loading=e))}firstUpdated(){h.fetchNetworkImage(this.network?.assets?.imageId)}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=!this.network||b.checkIfSupportedNetwork(this.network.chainNamespace);return D`
    ...
    `}getLabel(){return this.network?!this.isSupported&&!_.state.allowUnsupportedChain?`Switch Network`:this.network.name:this.label?this.label:this.caipAddress?`Unknown Network`:`Select Network`}onClick(){this.loading||(u.sendEvent({type:`track`,event:`CLICK_NETWORKS`}),x.open({view:`Networks`}))}};et.styles=Qe,$e([O({type:Boolean})],et.prototype,`disabled`,void 0),$e([O({type:String})],et.prototype,`label`,void 0),$e([P()],et.prototype,`network`,void 0),$e([P()],et.prototype,`networkImage`,void 0),$e([P()],et.prototype,`caipAddress`,void 0),$e([P()],et.prototype,`loading`,void 0),$e([P()],et.prototype,`isSupported`,void 0);var tt=class extends et{};tt=$e([j(`w3m-network-button`)],tt);var nt=class extends et{};nt=$e([j(`appkit-network-button`)],nt);var rt=A`
  :host {
    display: block;
  }
...
`,it=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},at=class extends I{constructor(){super(...arguments),this.label=``,this.description=``,this.icon=`wallet`}render(){return D`
    ...
    `}chooseNameButtonTemplate(){let e=this.network?.chainNamespace,t=g.getConnectorId(e),n=g.getAuthConnector();return!b.checkIfNamesSupported()||!n||t!==y.CONNECTOR_ID.AUTH||this.profileName?null:D`
      <wui-list-item
        icon="id"
        ?rounded=${!0}
        ?chevron=${!0}
    ...
    `}authCardTemplate(){let e=g.getConnectorId(this.network?.chainNamespace),t=g.getAuthConnector(),{origin:n}=location;return!t||e!==y.CONNECTOR_ID.AUTH||n.includes(p.SECURE_SITE)?null:D`
      <wui-notice-card
      ...
      ></wui-notice-card>
    `}isAllowedNetworkSwitch(){let e=b.getAllRequestedCaipNetworks(),t=e?e.length>1:!1,n=e?.find(({id:e})=>e===this.network?.id);return t||!n}onCopyAddress(){try{this.address&&(l.copyToClopboard(this.address),c.showSuccess(`Address copied`))}catch{c.showError(`Failed to copy`)}}smartAccountSettingsTemplate(){let e=this.network?.chainNamespace,t=b.checkIfSmartAccountEnabled(),n=g.getConnectorId(e);return!g.getAuthConnector()||n!==y.CONNECTOR_ID.AUTH||!t?null:D`
      <wui-list-item
        icon="user"
        ?rounded=${!0}
        ?chevron=${!0}
...
`,yt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},V=class extends I{constructor(){super(),this.unsubscribe=[],this.caipAddress=b.getAccountData()?.caipAddress,this.address=l.getPlainAddress(b.getAccountData()?.caipAddress),this.profileImage=b.getAccountData()?.profileImage,this.profileName=b.getAccountData()?.profileName,this.disconnecting=!1,this.balance=b.getAccountData()?.balance,this.balanceSymbol=b.getAccountData()?.balanceSymbol,this.features=_.state.features,this.remoteFeatures=_.state.remoteFeatures,this.namespace=b.state.activeChain,this.activeConnectorIds=g.state.activeConnectorIds,this.unsubscribe.push(b.subscribeChainProp(`accountState`,e=>{this.address=l.getPlainAddress(e?.caipAddress),this.caipAddress=e?.caipAddress,this.balance=e?.balance,this.balanceSymbol=e?.balanceSymbol,this.profileName=e?.profileName,this.profileImage=e?.profileImage}),_.subscribeKey(`features`,e=>this.features=e),_.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e),g.subscribeKey(`activeConnectorIds`,e=>{this.activeConnectorIds=e}),b.subscribeKey(`activeChain`,e=>this.namespace=e),b.subscribeKey(`activeCaipNetwork`,e=>{e?.chainNamespace&&(this.namespace=e?.chainNamespace)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.caipAddress||!this.namespace)return null;let e=this.activeConnectorIds[this.namespace],t=e?g.getConnectorById(e):void 0,n=h.getConnectorImage(t),{value:r,decimals:i,symbol:a}=l.parseBalance(this.balance,this.balanceSymbol);return D`<wui-flex
      ...
      </wui-flex>`}fundWalletTemplate(){if(!this.namespace)return null;let e=p.ONRAMP_SUPPORTED_CHAIN_NAMESPACES.includes(this.namespace),t=!!this.features?.receive,n=this.remoteFeatures?.onramp&&e,r=C.isPayWithExchangeEnabled();return!n&&!t&&!r?null:D`
      <wui-list-item
        .rounded=${!0}
    ...
    `}orderedFeaturesTemplate(){return(this.features?.walletFeaturesOrder||p.DEFAULT_FEATURES.walletFeaturesOrder).map(e=>{switch(e){case`onramp`:return this.fundWalletTemplate();case`swaps`:return this.swapsTemplate();case`send`:return this.sendTemplate();default:return null}})}activityTemplate(){return this.namespace&&this.remoteFeatures?.activity&&p.ACTIVITY_ENABLED_CHAIN_NAMESPACES.includes(this.namespace)?D` <wui-list-item
        ...
        </wui-list-item>`:null}swapsTemplate(){let e=this.remoteFeatures?.swaps,t=b.state.activeChain===y.CHAIN.EVM;return!e||!t?null:D`
      <wui-list-item
        .rounded=${!0}
    ...
    `}sendTemplate(){let e=this.features?.send,t=b.state.activeChain;if(!t)throw Error(`SendController:sendTemplate - namespace is required`);let n=p.SEND_SUPPORTED_NAMESPACES.includes(t);return!e||!n?null:D`
      <wui-list-item
        .rounded=${!0}
        icon="send"
        ?chevron=${!0}
    ...
    `}authCardTemplate(){let e=b.state.activeChain;if(!e)throw Error(`AuthCardTemplate:authCardTemplate - namespace is required`);let t=g.getConnectorId(e),n=g.getAuthConnector(),{origin:r}=location;return!n||t!==y.CONNECTOR_ID.AUTH||r.includes(p.SECURE_SITE)?null:D`
      <wui-notice-card
        @click=${this.onGoToUpgradeView.bind(this)}
        label="Upgrade your wallet"
        description="Transition to a self-custodial wallet"
...
`,xt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},St=class extends I{constructor(){super(...arguments),this.dollars=`0`,this.pennies=`00`}render(){return D`<span>$${this.dollars}<span class="pennies">.${this.pennies}</span></span>`}};St.styles=[N,bt],xt([O()],St.prototype,`dollars`,void 0),xt([O()],St.prototype,`pennies`,void 0),St=xt([j(`wui-balance`)],St);var Ct=A`
  :host {
    display: inline-flex;
    justify-content: center;
    align-items: center;
...
`,wt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Tt={sm:`sm-regular`,md:`md-regular`},Et=class extends I{constructor(){super(...arguments),this.placement=`top`,this.variant=`fill`,this.size=`md`,this.message=``}render(){return this.dataset.variant=this.variant,this.dataset.size=this.size,D`<wui-icon data-placement=${this.placement} size="inherit" name="cursor"></wui-icon>
      <wui-text variant=${Tt[this.size]}>${this.message}</wui-text>`}};Et.styles=[N,k,Ct],wt([O()],Et.prototype,`placement`,void 0),wt([O()],Et.prototype,`variant`,void 0),wt([O()],Et.prototype,`size`,void 0),wt([O()],Et.prototype,`message`,void 0),Et=wt([j(`wui-tooltip`)],Et);var Dt=E`
  :host {
    width: 100%;
    max-height: 280px;
    overflow: scroll;
...
`,Ot=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},kt=class extends I{render(){return D`<w3m-activity-list page="account"></w3m-activity-list>`}};kt.styles=Dt,kt=Ot([j(`w3m-account-activity-widget`)],kt);var At=A`
  :host {
    width: 100%;
  }
...
`,jt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Mt=class extends I{constructor(){super(...arguments),this.icon=`card`,this.text=``,this.description=``,this.tag=void 0,this.disabled=!1}render(){return D`
    ...
    `}};Mt.styles=[N,k,At],jt([O()],Mt.prototype,`icon`,void 0),jt([O()],Mt.prototype,`text`,void 0),jt([O()],Mt.prototype,`description`,void 0),jt([O()],Mt.prototype,`tag`,void 0),jt([O({type:Boolean})],Mt.prototype,`disabled`,void 0),Mt=jt([j(`wui-list-description`)],Mt);var Nt=E`
  :host {
    width: 100%;
  }
...
`,Pt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Ft=class extends I{constructor(){super(),this.unsubscribe=[],this.tokenBalance=b.getAccountData()?.tokenBalance,this.remoteFeatures=_.state.remoteFeatures,this.unsubscribe.push(b.subscribeChainProp(`accountState`,e=>{this.tokenBalance=e?.tokenBalance}),_.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return D`${this.tokenTemplate()}`}tokenTemplate(){return this.tokenBalance&&this.tokenBalance?.length>0?D`<wui-flex class="contentContainer" flexDirection="column" gap="2">
    ...
    ></wui-flex>`}onRampTemplate(){return this.remoteFeatures?.onramp?D`<wui-list-description
      ...
      ></wui-list-description>`:D``}tokenItemTemplate(){return this.tokenBalance?.map(e=>D`<wui-list-token
        ...
        ></wui-list-token>`)}onReceiveClick(){S.push(`WalletReceive`)}onBuyClick(){u.sendEvent({type:`track`,event:`SELECT_BUY_CRYPTO`,properties:{isSmartAccount:ae(b.state.activeChain)===ue.ACCOUNT_TYPES.SMART_ACCOUNT}}),S.push(`OnRampProviders`)}};Ft.styles=Nt,Pt([P()],Ft.prototype,`tokenBalance`,void 0),Pt([P()],Ft.prototype,`remoteFeatures`,void 0),Ft=Pt([j(`w3m-account-tokens-widget`)],Ft);var It=A`
  wui-flex {
    width: 100%;
  }
...
`,Lt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},H=class extends I{constructor(){super(...arguments),this.unsubscribe=[],this.network=b.state.activeCaipNetwork,this.profileName=b.getAccountData()?.profileName,this.address=b.getAccountData()?.address,this.currentTab=b.getAccountData()?.currentTab,this.tokenBalance=b.getAccountData()?.tokenBalance,this.features=_.state.features,this.namespace=b.state.activeChain,this.activeConnectorIds=g.state.activeConnectorIds,this.remoteFeatures=_.state.remoteFeatures}firstUpdated(){b.fetchTokenBalance(),this.unsubscribe.push(b.subscribeChainProp(`accountState`,e=>{e?.address?(this.address=e.address,this.profileName=e.profileName,this.currentTab=e.currentTab,this.tokenBalance=e.tokenBalance):x.close()}),g.subscribeKey(`activeConnectorIds`,e=>{this.activeConnectorIds=e}),b.subscribeKey(`activeChain`,e=>this.namespace=e),b.subscribeKey(`activeCaipNetwork`,e=>this.network=e),_.subscribeKey(`features`,e=>this.features=e),_.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e)),this.watchSwapValues()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),clearInterval(this.watchTokenBalance)}render(){if(!this.address)throw Error(`w3m-account-features-widget: No account provided`);if(!this.namespace)return null;let e=this.activeConnectorIds[this.namespace],t=e?g.getConnectorById(e):void 0,{icon:n,iconSize:r}=this.getAuthData();return D`<wui-flex
    ...
    </wui-flex>`}orderedWalletFeatures(){let e=this.features?.walletFeaturesOrder||p.DEFAULT_FEATURES.walletFeaturesOrder;if(e.every(e=>e===`send`||e===`receive`?!this.features?.[e]:e===`swaps`||e===`onramp`?!this.remoteFeatures?.[e]:!0))return null;let t=e.map(e=>e===`receive`||e===`onramp`?`fund`:e),n=[...new Set(t)];return D`<wui-flex gap="2">
    ...
    `}swapsTemplate(){let e=this.remoteFeatures?.swaps,t=b.state.activeChain===y.CHAIN.EVM;return!e||!t?null:D`
    ...
    `}sendTemplate(){let e=this.features?.send,t=b.state.activeChain,n=p.SEND_SUPPORTED_NAMESPACES.includes(t);return!e||!n?null:D`
...
`,U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},W=class extends I{constructor(){super(...arguments),this.address=``,this.profileName=``,this.content=[],this.alt=``,this.imageSrc=``,this.icon=void 0,this.iconSize=`md`,this.iconBadge=void 0,this.iconBadgeSize=`md`,this.buttonVariant=`neutral-primary`,this.enableMoreButton=!1,this.charsStart=4,this.charsEnd=6}render(){return D`
    ...
    `}dispatchDisconnectEvent(){this.dispatchEvent(new CustomEvent(`disconnect`,{bubbles:!0,composed:!0}))}dispatchSwitchEvent(){this.dispatchEvent(new CustomEvent(`switch`,{bubbles:!0,composed:!0}))}dispatchExternalLinkEvent(){this.dispatchEvent(new CustomEvent(`externalLink`,{bubbles:!0,composed:!0}))}dispatchMoreButtonEvent(){this.dispatchEvent(new CustomEvent(`more`,{bubbles:!0,composed:!0}))}dispatchCopyEvent(){this.dispatchEvent(new CustomEvent(`copy`,{bubbles:!0,composed:!0}))}};W.styles=[N,k,Bt],U([O()],W.prototype,`address`,void 0),U([O()],W.prototype,`profileName`,void 0),U([O({type:Array})],W.prototype,`content`,void 0),U([O()],W.prototype,`alt`,void 0),U([O()],W.prototype,`imageSrc`,void 0),U([O()],W.prototype,`icon`,void 0),U([O()],W.prototype,`iconSize`,void 0),U([O()],W.prototype,`iconBadge`,void 0),U([O()],W.prototype,`iconBadgeSize`,void 0),U([O()],W.prototype,`buttonVariant`,void 0),U([O({type:Boolean})],W.prototype,`enableMoreButton`,void 0),U([O({type:Number})],W.prototype,`charsStart`,void 0),U([O({type:Number})],W.prototype,`charsEnd`,void 0),W=U([j(`wui-active-profile-wallet-item`)],W);var Vt=A`
  wui-image,
  .icon-box {
    width: 32px;
    height: 32px;
...
`,G=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},K=class extends I{constructor(){super(...arguments),this.address=``,this.profileName=``,this.alt=``,this.buttonLabel=``,this.buttonVariant=`accent-primary`,this.imageSrc=``,this.icon=void 0,this.iconSize=`md`,this.iconBadgeSize=`md`,this.rightIcon=`signOut`,this.rightIconSize=`md`,this.loading=!1,this.charsStart=4,this.charsEnd=6}render(){return D`
    ...
    `}handleButtonClick(){this.dispatchEvent(new CustomEvent(`buttonClick`,{bubbles:!0,composed:!0}))}handleIconClick(){this.dispatchEvent(new CustomEvent(`iconClick`,{bubbles:!0,composed:!0}))}};K.styles=[N,k,Vt],G([O()],K.prototype,`address`,void 0),G([O()],K.prototype,`profileName`,void 0),G([O()],K.prototype,`alt`,void 0),G([O()],K.prototype,`buttonLabel`,void 0),G([O()],K.prototype,`buttonVariant`,void 0),G([O()],K.prototype,`imageSrc`,void 0),G([O()],K.prototype,`icon`,void 0),G([O()],K.prototype,`iconSize`,void 0),G([O()],K.prototype,`iconBadge`,void 0),G([O()],K.prototype,`iconBadgeSize`,void 0),G([O()],K.prototype,`rightIcon`,void 0),G([O()],K.prototype,`rightIconSize`,void 0),G([O({type:Boolean})],K.prototype,`loading`,void 0),G([O({type:Number})],K.prototype,`charsStart`,void 0),G([O({type:Number})],K.prototype,`charsEnd`,void 0),K=G([j(`wui-inactive-profile-wallet-item`)],K);var Ht={getAuthData(e){let t=e.connectorId===y.CONNECTOR_ID.AUTH;if(!t)return{isAuth:!1,icon:void 0,iconSize:void 0,name:void 0};let n=e?.auth?.name??ee.getConnectedSocialProvider(),r=e?.auth?.username??ee.getConnectedSocialUsername(),i=g.getAuthConnector()?.provider.getEmail()??``;return{isAuth:!0,icon:n??`mail`,iconSize:n?`xl`:`md`,name:t?re.getAuthName({email:i,socialUsername:r,socialProvider:n}):void 0}}},Ut=A`
  :host {
...
`,q=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},J={ADDRESS_DISPLAY:{START:4,END:6},BADGE:{SIZE:`md`,ICON:`lightbulb`},SCROLL_THRESHOLD:50,OPACITY_RANGE:[0,1]},Wt={eip155:`ethereum`,solana:`solana`,bip122:`bitcoin`,ton:`ton`,tron:`tron`},Gt=[{namespace:`eip155`,icon:Wt.eip155,label:`EVM`},{namespace:`solana`,icon:Wt.solana,label:`Solana`},{namespace:`bip122`,icon:Wt.bip122,label:`Bitcoin`},{namespace:`ton`,icon:Wt.ton,label:`Ton`},{namespace:`tron`,icon:Wt.tron,label:`Tron`}],Kt={eip155:{title:`Add EVM Wallet`,description:`Add your first EVM wallet`},solana:{title:`Add Solana Wallet`,description:`Add your first Solana wallet`},bip122:{title:`Add Bitcoin Wallet`,description:`Add your first Bitcoin wallet`},ton:{title:`Add TON Wallet`,description:`Add your first TON wallet`},tron:{title:`Add TRON Wallet`,description:`Add your first TRON wallet`}},Y=class extends I{constructor(){super(),this.unsubscribers=[],this.currentTab=0,this.namespace=b.state.activeChain,this.namespaces=Array.from(b.state.chains.keys()),this.caipAddress=void 0,this.profileName=void 0,this.activeConnectorIds=g.state.activeConnectorIds,this.lastSelectedAddress=``,this.lastSelectedConnectorId=``,this.isSwitching=!1,this.caipNetwork=b.state.activeCaipNetwork,this.user=b.getAccountData()?.user,this.remoteFeatures=_.state.remoteFeatures,this.currentTab=this.namespace?this.namespaces.indexOf(this.namespace):0,this.caipAddress=b.getAccountData(this.namespace)?.caipAddress,this.profileName=b.getAccountData(this.namespace)?.profileName,this.unsubscribers.push(v.subscribeKey(`connections`,()=>this.onConnectionsChange()),v.subscribeKey(`recentConnections`,()=>this.requestUpdate()),g.subscribeKey(`activeConnectorIds`,e=>{this.activeConnectorIds=e}),b.subscribeKey(`activeCaipNetwork`,e=>this.caipNetwork=e),b.subscribeChainProp(`accountState`,e=>{this.user=e?.user}),_.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e)),this.chainListener=b.subscribeChainProp(`accountState`,e=>{this.caipAddress=e?.caipAddress,this.profileName=e?.profileName},this.namespace)}disconnectedCallback(){this.unsubscribers.forEach(e=>e()),this.resizeObserver?.disconnect(),this.removeScrollListener(),this.chainListener?.()}firstUpdated(){let e=this.shadowRoot?.querySelector(`.wallet-list`);if(!e)return;let t=()=>this.updateScrollOpacity(e);requestAnimationFrame(t),e.addEventListener(`scroll`,t),this.resizeObserver=new ResizeObserver(t),this.resizeObserver.observe(e),t()}render(){let e=this.namespace;if(!e)throw Error(`Namespace is not set`);return D`
    ...
    `}renderRecentConnections(e){let{recentConnections:t}=ie.getConnectionsData(e);return t.flatMap(e=>e.accounts).length===0?null:D`
    ...
    `}renderConnectionList(e,t,n){return e.filter(e=>e.accounts.length>0).map((e,r)=>{let i=g.getConnectorById(e.connectorId),a=h.getConnectorImage(i)??``,o=Ht.getAuthData(e);return e.accounts.map((i,s)=>{let c=r!==0||s!==0,l=this.isAccountLoading(e.connectorId,i.address);return D`
    ...
    `}depositFromExchangeTemplate(){return!this.activeCaipNetwork||!C.isPayWithExchangeSupported()?null:D`
      <wui-list-item
    ...
    `:null}onBuyCrypto(){S.push(`OnRampProviders`)}onReceive(){S.push(`WalletReceive`)}onDepositFromExchange(){C.reset(),S.push(`PayWithExchange`,{redirectView:S.state.data?.redirectView})}};qt([P()],Jt.prototype,`activeCaipNetwork`,void 0),qt([P()],Jt.prototype,`features`,void 0),qt([P()],Jt.prototype,`remoteFeatures`,void 0),qt([P()],Jt.prototype,`exchangesLoading`,void 0),qt([P()],Jt.prototype,`exchanges`,void 0),Jt=qt([j(`w3m-fund-wallet-view`)],Jt);var Yt=A`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`,Xt=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Zt=class extends I{constructor(){super(...arguments),this.inputElementRef=Te(),this.checked=!1,this.disabled=!1,this.size=`md`}render(){return D`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent(`switchChange`,{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};Zt.styles=[N,k,Yt],Xt([O({type:Boolean})],Zt.prototype,`checked`,void 0),Xt([O({type:Boolean})],Zt.prototype,`disabled`,void 0),Xt([O()],Zt.prototype,`size`,void 0),Zt=Xt([j(`wui-toggle`)],Zt);var Qt=A`
  :host {
    height: auto;
  }
...
`,$t=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},en=class extends I{constructor(){super(...arguments),this.checked=!1}render(){return D`
      <wui-flex>
    ...
    `}handleToggleChange(e){e.stopPropagation(),this.checked=e.detail,this.dispatchSwitchEvent()}dispatchSwitchEvent(){this.dispatchEvent(new CustomEvent(`certifiedSwitchChange`,{detail:this.checked,bubbles:!0,composed:!0}))}};en.styles=[N,k,Qt],$t([O({type:Boolean})],en.prototype,`checked`,void 0),en=$t([j(`wui-certified-switch`)],en);var tn=A`
  :host {
    position: relative;
    display: inline-block;
    width: 100%;
...
`,nn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},rn=class extends I{constructor(){super(...arguments),this.inputComponentRef=Te(),this.inputValue=``}render(){return D`
      <wui-input-text
    ...
    `}onInputChange(e){this.inputValue=e.detail||``}clearValue(){let e=this.inputComponentRef.value?.inputElementRef.value;e&&(e.value=``,this.inputValue=``,e.focus(),e.dispatchEvent(new Event(`input`)))}};rn.styles=[N,tn],nn([O()],rn.prototype,`inputValue`,void 0),rn=nn([j(`wui-search-bar`)],rn);var an=A`
  :host {
    display: flex;
...
`,on=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},sn=class extends I{constructor(){super(...arguments),this.type=`wallet`}render(){return D`
    ...
    `}shimmerTemplate(){return this.type===`network`?D` <wui-shimmer data-type=${this.type} width="48px" height="54px"></wui-shimmer>
        ${be}`:D`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}};sn.styles=[N,k,an],on([O()],sn.prototype,`type`,void 0),sn=on([j(`wui-card-select-loader`)],sn);var cn=E`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
...
`,X=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Z=class extends I{render(){return this.style.cssText=`
    ...
    `,D`<slot></slot>`}};Z.styles=[N,cn],X([O()],Z.prototype,`gridTemplateRows`,void 0),X([O()],Z.prototype,`gridTemplateColumns`,void 0),X([O()],Z.prototype,`justifyItems`,void 0),X([O()],Z.prototype,`alignItems`,void 0),X([O()],Z.prototype,`justifyContent`,void 0),X([O()],Z.prototype,`alignContent`,void 0),X([O()],Z.prototype,`columnGap`,void 0),X([O()],Z.prototype,`rowGap`,void 0),X([O()],Z.prototype,`gap`,void 0),X([O()],Z.prototype,`padding`,void 0),X([O()],Z.prototype,`margin`,void 0),Z=X([j(`wui-grid`)],Z);var ln=A`
  button {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`,un=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},dn=class extends I{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.visible=!1,this.imageSrc=void 0,this.imageLoading=!1,this.isImpressed=!1,this.explorerId=``,this.walletQuery=``,this.certified=!1,this.displayIndex=0,this.wallet=void 0,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?(this.visible=!0,this.fetchImageSrc(),this.sendImpressionEvent()):this.visible=!1})},{threshold:.01})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){let e=this.wallet?.badge_type===`certified`;return D`
    ...
    `}shimmerTemplate(){return D`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}async fetchImageSrc(){this.wallet&&(this.imageSrc=h.getWalletImage(this.wallet),!this.imageSrc&&(this.imageLoading=!0,this.imageSrc=await h.fetchWalletImage(this.wallet.image_id),this.imageLoading=!1))}sendImpressionEvent(){!this.wallet||this.isImpressed||(this.isImpressed=!0,u.sendWalletImpressionEvent({name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.explorerId,view:S.state.view,query:this.walletQuery,certified:this.certified,displayIndex:this.displayIndex}))}};dn.styles=ln,un([P()],dn.prototype,`visible`,void 0),un([P()],dn.prototype,`imageSrc`,void 0),un([P()],dn.prototype,`imageLoading`,void 0),un([P()],dn.prototype,`isImpressed`,void 0),un([O()],dn.prototype,`explorerId`,void 0),un([O()],dn.prototype,`walletQuery`,void 0),un([O()],dn.prototype,`certified`,void 0),un([O()],dn.prototype,`displayIndex`,void 0),un([O({type:Object})],dn.prototype,`wallet`,void 0),dn=un([j(`w3m-all-wallets-list-item`)],dn);var fn=A`
  wui-grid {
...
`,pn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},mn=`local-paginator`,hn=class extends I{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.loading=!m.state.wallets.length,this.wallets=m.state.wallets,this.mobileFullScreen=_.state.enableMobileFullScreen,this.unsubscribe.push(m.subscribeKey(`wallets`,e=>this.wallets=e))}firstUpdated(){this.mobileFullScreen&&this.setAttribute(`data-mobile-fullscreen`,`true`),this.initialFetch(),this.createPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.paginationObserver?.disconnect()}render(){return D`
    ...
    `}async initialFetch(){this.loading=!0;let e=this.shadowRoot?.querySelector(`wui-grid`);e&&(await m.fetchWalletsByPage({page:1}),await e.animate([{opacity:1},{opacity:0}],{duration:200,fill:`forwards`,easing:`ease`}).finished,this.loading=!1,e.animate([{opacity:0},{opacity:1}],{duration:200,fill:`forwards`,easing:`ease`}))}shimmerTemplate(e,t){return[...Array(e)].map(()=>D`
      ...
      `)}walletsTemplate(){return le.getWalletConnectWallets(this.wallets).map((e,t)=>D`
        <w3m-all-wallets-list-item
...
`,_n=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},vn=class extends I{constructor(){super(...arguments),this.prevQuery=``,this.prevBadge=void 0,this.loading=!0,this.mobileFullScreen=_.state.enableMobileFullScreen,this.query=``}render(){return this.mobileFullScreen&&this.setAttribute(`data-mobile-fullscreen`,`true`),this.onSearch(),this.loading?D`<wui-loading-spinner color="accent-primary"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){(this.query.trim()!==this.prevQuery.trim()||this.badge!==this.prevBadge)&&(this.prevQuery=this.query,this.prevBadge=this.badge,this.loading=!0,await m.searchWallet({search:this.query,badge:this.badge}),this.loading=!1)}walletsTemplate(){let{search:e}=m.state,t=le.markWalletsAsInstalled(e),n=le.filterWalletsByWcSupport(t);return n.length?D`
      <wui-grid
    ...
    `:D`
      ...
      `}onConnectWallet(e){g.selectWalletConnector(e)}};vn.styles=gn,_n([P()],vn.prototype,`loading`,void 0),_n([P()],vn.prototype,`mobileFullScreen`,void 0),_n([O()],vn.prototype,`query`,void 0),_n([O()],vn.prototype,`badge`,void 0),vn=_n([j(`w3m-all-wallets-search`)],vn);var yn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},bn=class extends I{constructor(){super(...arguments),this.search=``,this.badge=void 0,this.onDebouncedSearch=l.debounce(e=>{this.search=e})}render(){let e=this.search.length>=2;return D`
    ...
    `}onInputChange(e){this.onDebouncedSearch(e.detail)}onCertifiedSwitchChange(e){e.detail?(this.badge=`certified`,c.showSvg(`Only WalletConnect certified`,{icon:`walletConnectBrown`,iconColor:`accent-100`})):this.badge=void 0}qrButtonTemplate(){return l.isMobile()?D`
        <wui-icon-box
          size="xl"
          iconSize="xl"
          color="accent-primary"
        ...
        ></wui-icon-box>
      `:null}onWalletConnectQr(){S.push(`ConnectingWalletConnect`)}};yn([P()],bn.prototype,`search`,void 0),yn([P()],bn.prototype,`badge`,void 0),bn=yn([j(`w3m-all-wallets-view`)],bn);var xn=A`
  button {
    display: flex;
    gap: ${({spacing:e})=>e[1]};
    padding: ${({spacing:e})=>e[4]};
...
`,Tn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},En=class extends I{constructor(){super(),this.unsubscribe=[],this.formRef=Te(),this.email=``,this.loading=!1,this.error=``,this.remoteFeatures=_.state.remoteFeatures,this.hasExceededUsageLimit=m.state.plan.hasExceededUsageLimit,this.unsubscribe.push(_.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e}),m.subscribeKey(`plan`,e=>this.hasExceededUsageLimit=e.hasExceededUsageLimit))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}firstUpdated(){this.formRef.value?.addEventListener(`keydown`,e=>{e.key===`Enter`&&this.onSubmitEmail(e)})}render(){let e=v.hasAnyConnection(y.CONNECTOR_ID.AUTH);return D`
...
`,jn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Mn=2,Nn=6,Pn=class extends I{constructor(){super(),this.unsubscribe=[],this.walletGuide=`get-started`,this.tabIdx=void 0,this.connectors=g.state.connectors,this.remoteFeatures=_.state.remoteFeatures,this.authConnector=this.connectors.find(e=>e.type===`AUTH`),this.isPwaLoading=!1,this.hasExceededUsageLimit=m.state.plan.hasExceededUsageLimit,this.unsubscribe.push(g.subscribeKey(`connectors`,e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>e.type===`AUTH`)}),_.subscribeKey(`remoteFeatures`,e=>this.remoteFeatures=e),m.subscribeKey(`plan`,e=>this.hasExceededUsageLimit=e.hasExceededUsageLimit))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return D`
      <wui-flex
        class="container"
        flexDirection="column"
        gap="2"
    ...
    `}topViewTemplate(){let e=this.walletGuide===`explore`,t=this.remoteFeatures?.socials;return!t&&e?(t=p.DEFAULT_SOCIALS,this.renderTopViewContent(t)):t?this.renderTopViewContent(t):null}renderTopViewContent(e){return e.length===2?D` <wui-flex gap="2">
      ...
      tabIdx=${M(this.tabIdx)}
      ?disabled=${this.isPwaLoading||this.hasConnection()}
    ></wui-list-button>`}bottomViewTemplate(){let e=this.remoteFeatures?.socials,t=this.walletGuide===`explore`;return(!this.authConnector||!e||e.length===0)&&t&&(e=p.DEFAULT_SOCIALS),!e||e.length<=Mn?null:e&&e.length>Nn?D`<wui-flex gap="2">
...
`,Un=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Wn=470,Q=class extends I{constructor(){super(),this.unsubscribe=[],this.connectors=g.state.connectors,this.authConnector=this.connectors.find(e=>e.type===`AUTH`),this.features=_.state.features,this.remoteFeatures=_.state.remoteFeatures,this.enableWallets=_.state.enableWallets,this.noAdapters=b.state.noAdapters,this.walletGuide=`get-started`,this.checked=ye.state.isLegalCheckboxChecked,this.isEmailEnabled=this.remoteFeatures?.email&&!b.state.noAdapters,this.isSocialEnabled=this.remoteFeatures?.socials&&this.remoteFeatures.socials.length>0&&!b.state.noAdapters,this.isAuthEnabled=this.checkIfAuthEnabled(this.connectors),this.unsubscribe.push(g.subscribeKey(`connectors`,e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>e.type===`AUTH`),this.isAuthEnabled=this.checkIfAuthEnabled(this.connectors)}),_.subscribeKey(`features`,e=>{this.features=e}),_.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e,this.setEmailAndSocialEnableCheck(this.noAdapters,this.remoteFeatures)}),_.subscribeKey(`enableWallets`,e=>this.enableWallets=e),b.subscribeKey(`noAdapters`,e=>this.setEmailAndSocialEnableCheck(e,this.remoteFeatures)),ye.subscribeKey(`isLegalCheckboxChecked`,e=>this.checked=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.resizeObserver?.disconnect(),(this.shadowRoot?.querySelector(`.connect`))?.removeEventListener(`scroll`,this.handleConnectListScroll.bind(this))}firstUpdated(){let e=this.shadowRoot?.querySelector(`.connect`);e&&(requestAnimationFrame(this.handleConnectListScroll.bind(this)),e?.addEventListener(`scroll`,this.handleConnectListScroll.bind(this)),this.resizeObserver=new ResizeObserver(()=>{this.handleConnectListScroll()}),this.resizeObserver?.observe(e),this.handleConnectListScroll())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=_.state,n=_.state.features?.legalCheckbox,r=!!(e||t)&&!!n&&this.walletGuide===`get-started`&&!this.checked,i={connect:!0,disabled:r},a=_.state.enableWalletGuide,o=this.enableWallets,s=this.isSocialEnabled||this.authConnector,c=r?-1:void 0;return D`
      <wui-flex flexDirection="column">
...
`,Yn=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Xn=class extends I{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display=`none`,null;let{name:e,app_store:t,play_store:n,chrome_store:r,homepage:i}=this.wallet,a=l.isMobile(),o=l.isIos(),s=l.isAndroid(),c=[t,n,i,r].filter(Boolean).length>1,u=F.getTruncateString({string:e,charsStart:12,charsEnd:0,truncate:`end`});return c&&!a?D`
        <wui-cta-button
          label=${`Don't have ${u}?`}
          buttonLabel="Get"
...
`,nr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},rr=class extends I{constructor(){super(),this.unsubscribe=[],this.activeConnector=g.state.activeConnector,this.unsubscribe.push(g.subscribeKey(`activeConnector`,e=>this.activeConnector=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return D`
      ...
      >
        <wui-flex justifyContent="center" alignItems="center">
          <wui-wallet-image
            size="lg"
            imageSrc=${M(h.getConnectorImage(this.activeConnector))}
          ></wui-wallet-image>
        </wui-flex>
        <wui-flex
          flexDirection="column"
    ...
    `}networksTemplate(){return this.activeConnector?.connectors?.map((e,t)=>e.name?D`
            <w3m-list-wallet
              displayIndex=${t}
              imageSrc=${M(h.getChainImage(e.chain))}
...
`,pr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},mr=class extends ${constructor(){super(),this.basic=!1}firstUpdated(){this.basic||u.sendEvent({type:`track`,event:`SELECT_WALLET`,properties:{name:this.wallet?.name??`WalletConnect`,platform:`qrcode`,displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:S.state.view}})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.forEach(e=>e())}render(){return this.onRenderProxy(),D`
    ...
    `}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0)}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let e=this.wallet?this.wallet.name:void 0;v.setWcLinking(void 0),v.setRecentWallet(this.wallet);let t=se.state.themeVariables[`--apkt-qr-color`]??se.state.themeVariables[`--w3m-qr-color`];return D` <wui-qr-code
      theme=${se.state.themeMode}
      uri=${this.uri}
      imageSrc=${M(h.getWalletImage(this.wallet))}
      color=${M(t)}
      alt=${M(e)}
    ...
    </wui-button>`}};mr.styles=fr,pr([O({type:Boolean})],mr.prototype,`basic`,void 0),mr=pr([j(`w3m-connecting-wc-qrcode`)],mr);var hr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},gr=class extends I{constructor(){if(super(),this.wallet=S.state.data?.wallet,!this.wallet)throw Error(`w3m-connecting-wc-unsupported: No wallet provided`);u.sendEvent({type:`track`,event:`SELECT_WALLET`,properties:{name:this.wallet.name,platform:`browser`,displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:S.state.view}})}render(){return D`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${[`10`,`5`,`5`,`5`]}
...
`,Tr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Er=class extends I{constructor(){super(...arguments),this.loading=!1}render(){return D`
    ...
    </wui-flex>`}handleContinue(){S.push(`RegisterAccountName`),u.sendEvent({type:`track`,event:`OPEN_ENS_FLOW`,properties:{isSmartAccount:ae(b.state.activeChain)===ue.ACCOUNT_TYPES.SMART_ACCOUNT}})}};Er.styles=wr,Tr([P()],Er.prototype,`loading`,void 0),Er=Tr([j(`w3m-choose-account-name-view`)],Er);var Dr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Or=class extends I{constructor(){super(...arguments),this.wallet=S.state.data?.wallet}render(){if(!this.wallet)throw Error(`w3m-downloads-view`);return D`
    ...
    `:null}openStore(e){e.href&&this.wallet&&(u.sendEvent({type:`track`,event:`GET_WALLET`,properties:{name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.wallet.id,type:e.type}}),l.openHref(e.href,`_blank`))}onChromeStore(){this.wallet?.chrome_store&&this.openStore({href:this.wallet.chrome_store,type:`chrome_store`})}onAppStore(){this.wallet?.app_store&&this.openStore({href:this.wallet.app_store,type:`app_store`})}onPlayStore(){this.wallet?.play_store&&this.openStore({href:this.wallet.play_store,type:`play_store`})}onHomePage(){this.wallet?.homepage&&this.openStore({href:this.wallet.homepage,type:`homepage`})}};Or=Dr([j(`w3m-downloads-view`)],Or);var kr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Ar=`https://walletguide.walletconnect.network`,jr=class extends I{render(){return D`
    ...
    `}recommendedWalletsTemplate(){let{recommended:e,featured:t}=m.state,{customWallets:n}=_.state;return[...t,...n??[],...e].slice(0,4).map((e,t)=>D`
        <w3m-list-wallet
          displayIndex=${t}
          name=${e.name??`Unknown`}
          tagVariant="accent"
          size="sm"
          imageSrc=${M(h.getWalletImage(e))}
          @click=${()=>{this.onWalletClick(e)}}
        ></w3m-list-wallet>
      `)}onWalletClick(e){u.sendEvent({type:`track`,event:`GET_WALLET`,properties:{name:e.name,walletRank:void 0,explorerId:e.id,type:`homepage`}}),l.openHref(e.homepage??Ar,`_blank`)}};jr=kr([j(`w3m-get-wallet-view`)],jr);var Mr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Nr=class extends I{constructor(){super(...arguments),this.data=[]}render(){return D`
    ...
    `}onGetWallet(){u.sendEvent({type:`track`,event:`CLICK_GET_WALLET_HELP`}),S.push(`GetWallet`)}};Ir=Pr([j(`w3m-what-is-a-wallet-view`)],Ir);var Lr=A`
  wui-flex {
...
`,Rr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},zr=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=ye.state.isLegalCheckboxChecked,this.unsubscribe.push(ye.subscribeKey(`isLegalCheckboxChecked`,e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=_.state,n=_.state.features?.legalCheckbox,r=!!(e||t)&&!!n,i=r&&!this.checked,a=i?-1:void 0;return D`
...
`,Wr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Gr=class extends I{constructor(){super(),this.network=S.state.data?.network,this.unsubscribe=[],this.showRetry=!1,this.error=!1}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}firstUpdated(){this.onSwitchNetwork()}render(){if(!this.network)throw Error(`w3m-network-switch-view: No network provided`);this.onShowRetry();let e=this.getLabel(),t=this.getSubLabel();return D`
      ...
      >
        <wui-flex justifyContent="center" alignItems="center">
          <wui-network-image
            size="lg"
            imageSrc=${M(h.getNetworkImage(this.network))}
          ></wui-network-image>
...
`,Xr=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},Zr=class extends I{constructor(){super(),this.unsubscribe=[],this.network=b.state.activeCaipNetwork,this.requestedCaipNetworks=b.getCaipNetworks(),this.search=``,this.onDebouncedSearch=l.debounce(e=>{this.search=e},100),this.unsubscribe.push(f.subscribeNetworkImages(()=>this.requestUpdate()),b.subscribeKey(`activeCaipNetwork`,e=>this.network=e),b.subscribe(()=>{this.requestedCaipNetworks=b.getAllRequestedCaipNetworks()}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return D`
    ...
    `}onInputChange(e){this.onDebouncedSearch(e.detail)}networksTemplate(){let e=b.getAllApprovedCaipNetworkIds(),t=l.sortRequestedNetworks(e,this.requestedCaipNetworks);return this.filteredNetworks=this.search?t?.filter(e=>e?.name?.toLowerCase().includes(this.search.toLowerCase())):t,this.filteredNetworks?.map(e=>D`
        <wui-list-network
          .selected=${this.network?.id===e.id}
          imageSrc=${M(h.getNetworkImage(e))}
          type="network"
          name=${e.name??e.id}
        ...
        ></wui-list-network>
      `)}onSwitchNetwork(e){oe.onSwitchNetwork({network:e})}};Zr.styles=Yr,Xr([P()],Zr.prototype,`network`,void 0),Xr([P()],Zr.prototype,`requestedCaipNetworks`,void 0),Xr([P()],Zr.prototype,`filteredNetworks`,void 0),Xr([P()],Zr.prototype,`search`,void 0),Zr=Xr([j(`w3m-networks-view`)],Zr);var Qr=A`
  @keyframes shake {
    0% {
      transform: translateX(0);
    }
...
`,oi=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},si=class extends I{constructor(){super(),this.swapUnsupportedChain=S.state.data?.swapUnsupportedChain,this.unsubscribe=[],this.disconnecting=!1,this.remoteFeatures=_.state.remoteFeatures,this.unsubscribe.push(f.subscribeNetworkImages(()=>this.requestUpdate()),_.subscribeKey(`remoteFeatures`,e=>{this.remoteFeatures=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return D`
    ...
    `}networksTemplate(){let e=b.getAllRequestedCaipNetworks(),t=b.getAllApprovedCaipNetworkIds(),n=l.sortRequestedNetworks(t,e);return(this.swapUnsupportedChain?n.filter(e=>p.SWAP_SUPPORTED_NETWORKS.includes(e.caipNetworkId)):n).map(e=>D`
        <wui-list-network
          imageSrc=${M(h.getNetworkImage(e))}
          name=${e.name??`Unknown`}
          @click=${()=>this.onSwitchNetwork(e)}
      ...
      `)}async onDisconnect(){try{this.disconnecting=!0;let e=b.state.activeChain,t=v.getConnections(e).length>0,n=e&&g.state.activeConnectorIds[e],r=this.remoteFeatures?.multiWallet;await v.disconnect(r?{id:n,namespace:e}:{}),t&&r&&(S.push(`ProfileWallets`),c.showSuccess(`Wallet deleted`))}catch{u.sendEvent({type:`track`,event:`DISCONNECT_ERROR`,properties:{message:`Failed to disconnect`}}),c.showError(`Failed to disconnect`)}finally{this.disconnecting=!1}}async onSwitchNetwork(e){let t=b.getActiveCaipAddress(),n=b.getAllApprovedCaipNetworkIds();b.getNetworkProp(`supportsAllNetworks`,e.chainNamespace);let r=S.state.data;t?n?.includes(e.caipNetworkId)?await b.switchActiveNetwork(e):S.push(`SwitchNetwork`,{...r,network:e}):t||(b.setActiveCaipNetwork(e),S.push(`Connect`))}};si.styles=ai,oi([P()],si.prototype,`disconnecting`,void 0),oi([P()],si.prototype,`remoteFeatures`,void 0),si=oi([j(`w3m-unsupported-chain-view`)],si);var ci=A`
  wui-flex {
    width: 100%;
    display: flex;
    align-items: center;
