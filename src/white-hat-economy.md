...
## <span class="emoji">📈</span> Onchain Debt Market
Deploy on-chain primitives such as AMMs and bonding curves to facilitate a debt market based on hacked LP tokens, using this as a mechanism to fund early-stage recovery.

## <span class="emoji">👁️</span> Public Watchlist
A continuously updated, open list of addresses, entities, and patterns linked to active investigations. Designed for integration by wallets, exchanges, and front ends so attackers face friction every time they try to move or off-ramp.
...
## <span class="emoji">🤝</span> Ongoing Negotiation Channel
Provides an ongoing negotiation channel with the hacker in order to recover as much of the loss as possible and to help facilitate the appropriate legal proceedings.

## <span class="emoji">🕵️</span> White Hat Guild
Direct sponsorship of white hat groups, independent investigators, forensic firms, and ex-law-enforcement specialists.
...
## <span class="emoji">🎓</span> Open Education and Training
Free curriculum, workshops, and tooling that lower the barrier for new investigators to participate. The more people who can read a transaction graph, the less defensible black-hat behavior becomes.
