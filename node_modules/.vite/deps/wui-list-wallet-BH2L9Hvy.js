import { b as RouterController, w as EventsController } from "./ModalController-D0mbRgVR.js";
...
import "./wui-network-image-D1a_UdLq.js";
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/modal/w3m-footer/styles.js
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/modal/w3m-footer/index.js
...
var W3mFooter = class W3mFooter extends LitElement {
	constructor() {
		super(...arguments);
	...
	templatePageContainer() {
		if (HelpersUtil.hasFooter()) return html` ${this.templateFooter()}`;
		return null;
	}
	templateFooter() {
		switch (this.view) {
			...
			case "OnRampTokenSelect": return html`<w3m-legal-footer></w3m-legal-footer>`;
			case "OnRampProviders": return html`<w3m-onramp-providers-footer></w3m-onramp-providers-footer>`;
			default: return null;
		}
	}
...
W3mFooter.styles = [styles_default$3];
__decorate$3([state()], W3mFooter.prototype, "status", void 0);
__decorate$3([state()], W3mFooter.prototype, "view", void 0);
W3mFooter = __decorate$3([customElement("w3m-footer")], W3mFooter);
//#endregion
...
var W3mRouter = class W3mRouter extends LitElement {
	...
	viewTemplate(view) {
		switch (view) {
			...
			case "DataCapture": return html`<w3m-data-capture-view></w3m-data-capture-view>`;
			case "DataCaptureOtpConfirm": return html`<w3m-data-capture-otp-confirm-view></w3m-data-capture-otp-confirm-view>`;
			...
			case "ProfileWallets": return html`<w3m-profile-wallets-view></w3m-profile-wallets-view>`;
			...
			case "WalletSendConfirmed": return html`<w3m-send-confirmed-view></w3m-send-confirmed-view>`;
			...
			case "PayQuote": return html`<w3m-pay-quote-view></w3m-pay-quote-view>`;
			case "FundWallet": return html`<w3m-fund-wallet-view></w3m-fund-wallet-view>`;
			case "PayWithExchange": return html`<w3m-deposit-from-exchange-view></w3m-deposit-from-exchange-view>`;
			case "PayWithExchangeSelectAsset": return html`<w3m-deposit-from-exchange-select-asset-view></w3m-deposit-from-exchange-select-asset-view>`;
			case "UsageExceeded": return html`<w3m-usage-exceeded-view></w3m-usage-exceeded-view>`;
			case "SmartAccountSettings": return html`<w3m-smart-account-settings-view></w3m-smart-account-settings-view>`;
			default: return html`<w3m-connect-view></w3m-connect-view>`;
		}
	}
};
W3mRouter.styles = [styles_default$2];
__decorate$2([state()], W3mRouter.prototype, "viewState", void 0);
__decorate$2([state()], W3mRouter.prototype, "history", void 0);
W3mRouter = __decorate$2([customElement("w3m-router")], W3mRouter);
//#endregion
...
WuiAllWalletsImage.styles = [resetStyles, styles_default$1];
__decorate$1([property({ type: Array })], WuiAllWalletsImage.prototype, "walletImages", void 0);
WuiAllWalletsImage = __decorate$1([customElement("wui-all-wallets-image")], WuiAllWalletsImage);
//#endregion
...
var WuiListWallet = class WuiListWallet extends LitElement {
	...
	templateNamespaces() {
		if (this.namespaces?.length) return html`<wui-flex alignItems="center" gap="0">
	...
	templateStatus() {
		if (this.loading) return html`<wui-loading-spinner size="lg" color="accent-primary"></wui-loading-spinner>`;
		else if (this.tagLabel && this.tagVariant) return html`<wui-tag size="sm" variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`;
		return null;
	}
};
...
__decorate([property({ type: Array })], WuiListWallet.prototype, "walletImages", void 0);
__decorate([property()], WuiListWallet.prototype, "imageSrc", void 0);
__decorate([property()], WuiListWallet.prototype, "name", void 0);
__decorate([property()], WuiListWallet.prototype, "size", void 0);
...
__decorate([property()], WuiListWallet.prototype, "tabIdx", void 0);
__decorate([property({ type: Array })], WuiListWallet.prototype, "namespaces", void 0);
__decorate([property({ type: Boolean })], WuiListWallet.prototype, "disabled", void 0);
__decorate([property({ type: Boolean })], WuiListWallet.prototype, "showAllWallets", void 0);
__decorate([property({ type: Boolean })], WuiListWallet.prototype, "loading", void 0);
__decorate([property({ type: String })], WuiListWallet.prototype, "loadingSpinnerColor", void 0);
WuiListWallet = __decorate([customElement("wui-list-wallet")], WuiListWallet);
//#endregion
export { W3mFooter as n, W3mRouter as t };

//# sourceMappingURL=wui-list-wallet-BH2L9Hvy.js.map