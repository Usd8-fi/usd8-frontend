import { H as CoreHelperUtil, V as W3mFrameRpcConstants, W as ConstantsUtil, b as RouterController, g as getPreferredAccountType, r as ChainController, t as ModalController, ut as NumberUtil, w as EventsController } from "./ModalController-D0mbRgVR.js";
import { T as MathUtil, _ as css, c as property, f as elementStyles, l as customElement, m as resetStyles, s as state, x as html, y as LitElement } from "./wui-text-CswcyjL8.js";
import { t as SwapController } from "./SwapController-DGnNHfJa.js";
import "./w3m-tooltip-SBbCyA0L.js";
import "./wui-image-nxfC3WHw.js";
import "./wui-icon-BZGJSt7Q.js";
import "./wui-button-rVCHkJnG.js";
import "./wui-icon-box-CC36-Nh6.js";
import "./wui-shimmer-BRzAiFZU.js";
import "./wui-shimmer-C-effZBM.js";
import "./wui-input-text-BMgscJQ8.js";
import "./wui-token-button-QBJ7yEI-.js";
//#region node_modules/@reown/appkit-common/dist/esm/src/utils/InputUtil.js
var InputUtil = { numericInputKeyDown(event, currentValue, onChange) {
	const allowedKeys = [
		"Backspace",
		"Meta",
		"Ctrl",
	...
	if (!controlPressed && (selectAll || copyKey || pasteKey || cutKey)) event.preventDefault();
	if (currentValue === "0" && !isComma && !isDot && eventKey === "0") event.preventDefault();
	...
	if (isComma || isDot) {
		...
		if (currentValue?.includes(".") || currentValue?.includes(",")) event.preventDefault();
	}
	if (!isNumericKey && !allowedKeys.includes(eventKey) && !isDot && !isComma) event.preventDefault();
} };
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-swap-details/styles.js
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-swap-details/index.js
...
var WuiSwapDetails = class WuiSwapDetails extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
...
WuiSwapDetails.styles = [styles_default$7];
__decorate$7([state()], WuiSwapDetails.prototype, "networkName", void 0);
__decorate$7([property()], WuiSwapDetails.prototype, "detailsOpen", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "sourceToken", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "toToken", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "toTokenAmount", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "sourceTokenPriceInUSD", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "toTokenPriceInUSD", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "priceImpact", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "maxSlippage", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "networkTokenSymbol", void 0);
__decorate$7([state()], WuiSwapDetails.prototype, "inputError", void 0);
WuiSwapDetails = __decorate$7([customElement("w3m-swap-details")], WuiSwapDetails);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-swap-input-skeleton/index.js
...
var W3mSwapInputSkeleton = class W3mSwapInputSkeleton extends LitElement {
	constructor() {
		super(...arguments);
...
W3mSwapInputSkeleton.styles = [styles_default$6];
__decorate$6([property()], W3mSwapInputSkeleton.prototype, "target", void 0);
W3mSwapInputSkeleton = __decorate$6([customElement("w3m-swap-input-skeleton")], W3mSwapInputSkeleton);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-swap-input/index.js
...
var W3mSwapInput = class W3mSwapInput extends LitElement {
	constructor() {
		super(...arguments);
		this.focused = false;
		this.price = 0;
	...
	firstUpdated() {
		if (this.autoFocus) requestAnimationFrame(() => {
	...
	dispatchInputChangeEvent(event) {
		...
		if (value === "," || value === ".") this.onSetAmount(this.target, "0.");
		else if (value.endsWith(",")) this.onSetAmount(this.target, value.replace(",", "."));
		else this.onSetAmount(this.target, value);
	}
	setMaxValueToInput() {
		this.onSetMaxValue?.(this.target, this.balance);
	}
	templateTokenSelectButton() {
		if (!this.token) return html` <wui-button
	...
	tokenActionButtonTemplate(haveBalance) {
		if (haveBalance) return html` <button class="max-value-button" @click=${this.setMaxValueToInput.bind(this)}>
	...
	onSelectToken() {
		...
		RouterController.push("SwapSelectToken", { target: this.target });
	}
	onBuyToken() {
		RouterController.push("OnRampProviders");
	}
};
W3mSwapInput.styles = [styles_default$5];
__decorate$5([property()], W3mSwapInput.prototype, "focused", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "balance", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "value", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "price", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "marketValue", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "disabled", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "target", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "token", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "onSetAmount", void 0);
__decorate$5([property()], W3mSwapInput.prototype, "onSetMaxValue", void 0);
__decorate$5([property({ type: Boolean })], W3mSwapInput.prototype, "autoFocus", void 0);
W3mSwapInput = __decorate$5([customElement("w3m-swap-input")], W3mSwapInput);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-swap-view/index.js
...
var W3mSwapView = class W3mSwapView extends LitElement {
	...
	constructor() {
		...
		this.visibilityChangeHandler = () => {
			...
			} else this.startTokenPriceInterval();
		};
		this.startTokenPriceInterval = () => {
			if (this.interval && Date.now() - this.lastTokenPriceUpdate < this.minTokenPriceUpdateInterval) return;
			if (this.lastTokenPriceUpdate && Date.now() - this.lastTokenPriceUpdate > this.minTokenPriceUpdateInterval) this.fetchTokensAndValues();
			clearInterval(this.interval);
		...
		this.watchTokensAndValues = () => {
			if (!this.sourceToken || !this.toToken) return;
		...
		this.unsubscribe.push(...[
			...
			ModalController.subscribeKey("open", (isOpen) => {
				if (!isOpen) SwapController.resetState();
			}),
			RouterController.subscribeKey("view", (newRoute) => {
				if (!newRoute.includes("Swap")) SwapController.resetValues();
			}),
			SwapController.subscribe((newState) => {
				...
				if (newState.sourceToken && newState.toToken) this.watchTokensAndValues();
			})
		]);
	}
	async firstUpdated() {
	...
	actionButtonLabel() {
		...
		if (this.fetchError) return "Swap";
		if (!this.sourceToken || !this.toToken) return "Select token";
		if (haveNoAmount) return "Enter amount";
		if (this.inputError) return this.inputError;
		return "Review swap";
	}
	...
	onSetMaxValue(target, balance) {
		...
		if (target === "sourceToken" && token?.address === networkAddress && gasFee && gasFee !== "0") {
			const gasCostWei = 150000n * BigInt(gasFee);
		...
		} else this.handleChangeAmount(target, maxValue.toFixed(decimals, 0));
	}
	templateDetails() {
		if (!this.sourceToken || !this.toToken || this.inputError) return null;
	...
	handleChangeAmount(target, value) {
		...
		if (target === "sourceToken") SwapController.setSourceTokenAmount(value);
		else SwapController.setToTokenAmount(value);
	...
	async onSwapPreview() {
		if (this.fetchError) await SwapController.swapTokens();
		EventsController.sendEvent({
			type: "track",
			event: "INITIATE_SWAP",
			properties: {
	...
	async handleSwapParameters() {
		...
		if (!SwapController.state.initialized) await new Promise((resolve) => {
	...
	async setSwapParameters({ amount, fromToken, toToken }) {
		if (!SwapController.state.tokens || !SwapController.state.myTokensWithBalance) await new Promise((resolve) => {
		...
		const allTokens = [...SwapController.state.tokens || [], ...SwapController.state.myTokensWithBalance || []];
		if (fromToken) {
			const token = allTokens.find((t) => t.symbol.toLowerCase() === fromToken.toLowerCase());
			if (token) SwapController.setSourceToken(token);
		}
		if (toToken) {
			const token = allTokens.find((t) => t.symbol.toLowerCase() === toToken.toLowerCase());
			if (token) SwapController.setToToken(token);
		}
		if (amount && !isNaN(Number(amount))) SwapController.setSourceTokenAmount(amount);
	}
	onCaipAddressChange({ newCaipAddress, resetSwapState, initializeSwapState }) {
		if (this.caipAddress !== newCaipAddress) {
			...
			if (resetSwapState) SwapController.resetState();
			if (initializeSwapState) SwapController.initializeState();
		}
	}
...
W3mSwapView.styles = styles_default$4;
__decorate$4([property({ type: Object })], W3mSwapView.prototype, "initialParams", void 0);
__decorate$4([state()], W3mSwapView.prototype, "interval", void 0);
__decorate$4([state()], W3mSwapView.prototype, "detailsOpen", void 0);
__decorate$4([state()], W3mSwapView.prototype, "caipAddress", void 0);
__decorate$4([state()], W3mSwapView.prototype, "caipNetworkId", void 0);
__decorate$4([state()], W3mSwapView.prototype, "initialized", void 0);
__decorate$4([state()], W3mSwapView.prototype, "loadingQuote", void 0);
__decorate$4([state()], W3mSwapView.prototype, "loadingPrices", void 0);
__decorate$4([state()], W3mSwapView.prototype, "loadingTransaction", void 0);
__decorate$4([state()], W3mSwapView.prototype, "sourceToken", void 0);
__decorate$4([state()], W3mSwapView.prototype, "sourceTokenAmount", void 0);
__decorate$4([state()], W3mSwapView.prototype, "sourceTokenPriceInUSD", void 0);
__decorate$4([state()], W3mSwapView.prototype, "toToken", void 0);
__decorate$4([state()], W3mSwapView.prototype, "toTokenAmount", void 0);
__decorate$4([state()], W3mSwapView.prototype, "toTokenPriceInUSD", void 0);
__decorate$4([state()], W3mSwapView.prototype, "inputError", void 0);
__decorate$4([state()], W3mSwapView.prototype, "fetchError", void 0);
__decorate$4([state()], W3mSwapView.prototype, "lastTokenPriceUpdate", void 0);
W3mSwapView = __decorate$4([customElement("w3m-swap-view")], W3mSwapView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-swap-preview-view/index.js
...
var W3mSwapPreviewView = class W3mSwapPreviewView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		...
		this.unsubscribe.push(...[
			ChainController.subscribeChainProp("accountState", (val) => {
				if (val?.balanceSymbol !== this.balanceSymbol) RouterController.goBack();
			}),
			ChainController.subscribeKey("activeCaipNetwork", (newCaipNetwork) => {
				if (this.caipNetwork !== newCaipNetwork) this.caipNetwork = newCaipNetwork;
			}),
			SwapController.subscribe((newState) => {
				...
				this.toTokenAmount = newState.toTokenAmount ?? "";
				this.inputError = newState.inputError;
				if (newState.inputError) RouterController.goBack();
				this.loadingQuote = newState.loadingQuote;
	...
	refreshTransaction() {
		this.interval = setInterval(() => {
			if (!SwapController.getApprovalLoadingState()) SwapController.getTransaction();
		}, 1e4);
	}
	templateSwap() {
	...
	actionButtonLabel() {
		if (this.loadingApprovalTransaction) return "Approving...";
		if (this.approvalTransaction) return "Approve";
		return "Swap";
	}
	onCancelTransaction() {
	...
	onSendTransaction() {
		if (this.approvalTransaction) SwapController.sendTransactionForApproval(this.approvalTransaction);
		else SwapController.sendTransactionForSwap(this.swapTransaction);
	}
};
W3mSwapPreviewView.styles = styles_default$3;
__decorate$3([state()], W3mSwapPreviewView.prototype, "interval", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "detailsOpen", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "approvalTransaction", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "swapTransaction", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "sourceToken", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "sourceTokenAmount", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "sourceTokenPriceInUSD", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "balanceSymbol", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "toToken", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "toTokenAmount", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "toTokenPriceInUSD", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "caipNetwork", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "inputError", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "loadingQuote", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "loadingApprovalTransaction", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "loadingBuildTransaction", void 0);
__decorate$3([state()], W3mSwapPreviewView.prototype, "loadingTransaction", void 0);
W3mSwapPreviewView = __decorate$3([customElement("w3m-swap-preview-view")], W3mSwapPreviewView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-ui/dist/esm/src/composites/wui-token-list-item/index.js
...
var WuiTokenListItem = class WuiTokenListItem extends LitElement {
	constructor() {
		super();
	...
	visualTemplate() {
		if (this.imageError) return html`<wui-flex class="token-item-image-placeholder">
        <wui-icon name="image" color="inherit"></wui-icon>
      </wui-flex>`;
		if (this.imageSrc) return html`<wui-image
        width="40"
        height="40"
        src=${this.imageSrc}
...
__decorate$2([property()], WuiTokenListItem.prototype, "imageSrc", void 0);
__decorate$2([property()], WuiTokenListItem.prototype, "name", void 0);
__decorate$2([property()], WuiTokenListItem.prototype, "symbol", void 0);
__decorate$2([property()], WuiTokenListItem.prototype, "price", void 0);
__decorate$2([property()], WuiTokenListItem.prototype, "amount", void 0);
__decorate$2([state()], WuiTokenListItem.prototype, "visible", void 0);
__decorate$2([state()], WuiTokenListItem.prototype, "imageError", void 0);
WuiTokenListItem = __decorate$2([customElement("wui-token-list-item")], WuiTokenListItem);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-ui/dist/esm/src/composites/wui-token-list-item-loader/index.js
...
var WuiTokenListItemLoader = class WuiTokenListItemLoader extends LitElement {
	render() {
		return html`
      <wui-flex alignItems="center">
...
WuiTokenListItemLoader.styles = [resetStyles, styles_default$1];
WuiTokenListItemLoader = __decorate$1([customElement("wui-token-list-item-loader")], WuiTokenListItemLoader);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-swap-select-token-view/index.js
...
var W3mSwapSelectTokenView = class W3mSwapSelectTokenView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
	...
	updated() {
		(this.renderRoot?.querySelector(".suggested-tokens-container"))?.addEventListener("scroll", this.handleSuggestedTokensScroll.bind(this));
	...
	onSelectToken(token) {
		if (this.targetToken === "sourceToken") SwapController.setSourceToken(token);
		else {
			SwapController.setToToken(token);
			if (this.sourceToken && this.sourceTokenAmount) SwapController.swapTokens();
		}
		RouterController.goBack();
	}
	templateSearchInput() {
	...
	templateMyTokens() {
		...
		if (filteredYourTokens?.length > 0) return html`<wui-flex justifyContent="flex-start" padding="2">
        ...
        ${filteredYourTokens.map((token) => {
            ...
            <wui-token-list-item
              ...
              @click=${() => {
				if (!selected) this.onSelectToken(token);
			}}
            >
            </wui-token-list-item>
          `;
	...
	templateAllTokens() {
		...
		if (this.tokensLoading) return html`
        ...
        <wui-token-list-item-loader></wui-token-list-item-loader>
      `;
		if (filteredTokens?.length > 0) return html`
	...
	filterTokensWithText(tokens, text) {
		return tokens.filter((token) => `${token.symbol} ${token.name} ${token.address}`.toLowerCase().includes(text.toLowerCase())).sort((a, b) => {
			...
			return aText.indexOf(text.toLowerCase()) - bText.indexOf(text.toLowerCase());
		});
	}
};
W3mSwapSelectTokenView.styles = styles_default;
__decorate([state()], W3mSwapSelectTokenView.prototype, "interval", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "targetToken", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "sourceToken", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "sourceTokenAmount", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "toToken", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "myTokensWithBalance", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "popularTokens", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "suggestedTokens", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "tokensLoading", void 0);
__decorate([state()], W3mSwapSelectTokenView.prototype, "searchValue", void 0);
W3mSwapSelectTokenView = __decorate([customElement("w3m-swap-select-token-view")], W3mSwapSelectTokenView);
//#endregion
export { W3mSwapPreviewView, W3mSwapSelectTokenView, W3mSwapView };

//# sourceMappingURL=swaps-C5QSdbPu.js.map