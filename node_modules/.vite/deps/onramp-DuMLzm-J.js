import { D as AssetController, E as AssetUtil, H as CoreHelperUtil, M as OptionsController, V as W3mFrameRpcConstants, b as RouterController, g as getPreferredAccountType, j as SnackController, l as ConnectionController, r as ChainController, t as ModalController, w as EventsController, y as ThemeController } from "./ModalController-D0mbRgVR.js";
import { _ as css, c as property, l as customElement, o as ifDefined, s as state, x as html, y as LitElement } from "./wui-text-CswcyjL8.js";
import { t as OnRampController } from "./OnRampController-CWgF9Rw2.js";
import { t as OptionsStateController } from "./wui-loading-thumbnail-CBhooMbk.js";
import "./w3m-onramp-providers-footer-GJCnV4gR.js";
import "./wui-icon-BZGJSt7Q.js";
import "./wui-link-VY7RarQC.js";
import "./wui-list-item-CxcGsY8y.js";
import "./wui-button-rVCHkJnG.js";
import "./wui-icon-box-CC36-Nh6.js";
import "./wui-loading-spinner-CY8HcH0_.js";
import "./wui-visual-CFSCGjz6.js";
import "./wui-input-text-BMgscJQ8.js";
import "./wui-image-DKAPbmfA.js";
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-onramp-fiat-select-view/index.js
...
var W3mOnrampFiatSelectView = class W3mOnrampFiatSelectView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
	...
	render() {
		...
		const disabled = Boolean(termsConditionsUrl || privacyPolicyUrl) && Boolean(legalCheckbox) && !this.checked;
		return html`
...
W3mOnrampFiatSelectView.styles = styles_default$5;
__decorate$7([state()], W3mOnrampFiatSelectView.prototype, "selectedCurrency", void 0);
__decorate$7([state()], W3mOnrampFiatSelectView.prototype, "currencies", void 0);
__decorate$7([state()], W3mOnrampFiatSelectView.prototype, "currencyImages", void 0);
__decorate$7([state()], W3mOnrampFiatSelectView.prototype, "checked", void 0);
W3mOnrampFiatSelectView = __decorate$7([customElement("w3m-onramp-fiat-select-view")], W3mOnrampFiatSelectView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-onramp-provider-item/index.js
...
var W3mOnRampProviderItem = class W3mOnRampProviderItem extends LitElement {
	constructor() {
		super(...arguments);
		this.disabled = false;
		this.color = "inherit";
	...
	networksTemplate() {
      ...
      <wui-flex class="networks">
        ${(ChainController.getAllRequestedCaipNetworks()?.filter((network) => network?.assets?.imageId)?.slice(0, 5))?.map((network) => html`
...
W3mOnRampProviderItem.styles = [styles_default$4];
__decorate$6([property({ type: Boolean })], W3mOnRampProviderItem.prototype, "disabled", void 0);
__decorate$6([property()], W3mOnRampProviderItem.prototype, "color", void 0);
__decorate$6([property()], W3mOnRampProviderItem.prototype, "name", void 0);
__decorate$6([property()], W3mOnRampProviderItem.prototype, "label", void 0);
__decorate$6([property()], W3mOnRampProviderItem.prototype, "feeRange", void 0);
__decorate$6([property({ type: Boolean })], W3mOnRampProviderItem.prototype, "loading", void 0);
__decorate$6([property()], W3mOnRampProviderItem.prototype, "onClick", void 0);
W3mOnRampProviderItem = __decorate$6([customElement("w3m-onramp-provider-item")], W3mOnRampProviderItem);
//#endregion
...
var W3mOnRampProvidersView = class W3mOnRampProvidersView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
...
__decorate$5([state()], W3mOnRampProvidersView.prototype, "providers", void 0);
W3mOnRampProvidersView = __decorate$5([customElement("w3m-onramp-providers-view")], W3mOnRampProvidersView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-onramp-tokens-select-view/index.js
...
var W3mOnrampTokensView = class W3mOnrampTokensView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
...
W3mOnrampTokensView.styles = styles_default$3;
__decorate$4([state()], W3mOnrampTokensView.prototype, "selectedCurrency", void 0);
__decorate$4([state()], W3mOnrampTokensView.prototype, "tokens", void 0);
__decorate$4([state()], W3mOnrampTokensView.prototype, "tokenImages", void 0);
__decorate$4([state()], W3mOnrampTokensView.prototype, "checked", void 0);
W3mOnrampTokensView = __decorate$4([customElement("w3m-onramp-token-select-view")], W3mOnrampTokensView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-buy-in-progress-view/index.js
...
var W3mBuyInProgressView = class W3mBuyInProgressView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		...
		this.isMobile = false;
		this.onRetry = void 0;
		this.unsubscribe.push(...[OnRampController.subscribeKey("selectedProvider", (val) => {
	...
	render() {
		...
		if (this.error) label = "Buy failed";
		else if (this.selectedOnRampProvider) label = `Buy in ${this.selectedOnRampProvider?.label}`;
	...
	tryAgainTemplate() {
		if (!this.selectedOnRampProvider?.url) return null;
...
W3mBuyInProgressView.styles = styles_default$2;
__decorate$3([state()], W3mBuyInProgressView.prototype, "intervalId", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "selectedOnRampProvider", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "uri", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "ready", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "showRetry", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "buffering", void 0);
__decorate$3([state()], W3mBuyInProgressView.prototype, "error", void 0);
__decorate$3([property({ type: Boolean })], W3mBuyInProgressView.prototype, "isMobile", void 0);
__decorate$3([property()], W3mBuyInProgressView.prototype, "onRetry", void 0);
W3mBuyInProgressView = __decorate$3([customElement("w3m-buy-in-progress-view")], W3mBuyInProgressView);
//#endregion
...
var W3mWhatIsABuyView = class W3mWhatIsABuyView extends LitElement {
	render() {
		return html`
      <wui-flex
        flexDirection="column"
...
W3mWhatIsABuyView = __decorate$2([customElement("w3m-what-is-a-buy-view")], W3mWhatIsABuyView);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-onramp-input/index.js
...
var W3mInputCurrency = class W3mInputCurrency extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.type = "Token";
		...
		this.unsubscribe.push(OnRampController.subscribeKey("purchaseCurrency", (val) => {
			if (!val || this.type === "Fiat") return;
			this.selectedCurrency = this.formatPurchaseCurrency(val);
		}), OnRampController.subscribeKey("paymentCurrency", (val) => {
			if (!val || this.type === "Token") return;
			this.selectedCurrency = this.formatPaymentCurrency(val);
		}), OnRampController.subscribe((val) => {
			if (this.type === "Fiat") this.currencies = val.purchaseCurrencies.map(this.formatPurchaseCurrency);
			else this.currencies = val.paymentCurrencies.map(this.formatPaymentCurrency);
...
W3mInputCurrency.styles = styles_default$1;
__decorate$1([property({ type: String })], W3mInputCurrency.prototype, "type", void 0);
__decorate$1([property({ type: Number })], W3mInputCurrency.prototype, "value", void 0);
__decorate$1([state()], W3mInputCurrency.prototype, "currencies", void 0);
__decorate$1([state()], W3mInputCurrency.prototype, "selectedCurrency", void 0);
__decorate$1([state()], W3mInputCurrency.prototype, "currencyImages", void 0);
__decorate$1([state()], W3mInputCurrency.prototype, "tokenImages", void 0);
W3mInputCurrency = __decorate$1([customElement("w3m-onramp-input")], W3mInputCurrency);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/modal/w3m-onramp-widget/index.js
...
var BUY_PRESET_AMOUNTS = [
	100,
	250,
	500,
	1e3
];
var W3mOnrampWidget = class W3mOnrampWidget extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		this.disabled = false;
	...
	getQuotes() {
		if (!this.loading) ModalController.open({ view: "OnRampProviders" });
	}
	openModal() {
...
W3mOnrampWidget.styles = styles_default;
__decorate([property({ type: Boolean })], W3mOnrampWidget.prototype, "disabled", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "caipAddress", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "loading", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "paymentCurrency", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "paymentAmount", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "purchaseAmount", void 0);
__decorate([state()], W3mOnrampWidget.prototype, "quoteLoading", void 0);
W3mOnrampWidget = __decorate([customElement("w3m-onramp-widget")], W3mOnrampWidget);
//#endregion
export { W3mBuyInProgressView, W3mOnRampProvidersView, W3mOnrampFiatSelectView, W3mOnrampTokensView, W3mOnrampWidget, W3mWhatIsABuyView };

//# sourceMappingURL=onramp-DuMLzm-J.js.map