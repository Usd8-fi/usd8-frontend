import { o as __toESM, t as __commonJSMin } from "./chunk-BmQy1IqS.js";
import { Cn as isAddressEqual, Ea as isAddress, Ga as toHex$2, Gr as ContractFunctionExecutionError, Io as size$2, Kr as ContractFunctionRevertedError, La as hexToBytes, Li as parseAbi, Lo as isHex, Oa as keccak256, Po as BaseError$1, Si as parseAccount, Ta as getAddress, Ua as numberToHex, Uo as erc20Abi, Wa as stringToHex, Xa as hexToString, Ya as hexToNumber, Za as trim, bi as decodeErrorResult, da as concat$1, en as serializeStateOverride, ki as encodeFunctionData, oa as decodeAbiParameters, pi as formatGwei, qa as hexToBigInt, qr as ContractFunctionZeroDataError, ro as pad$1, sa as encodeAbiParameters, ui as prettyPrint, ya as slice$2, yi as stringify$1, za as stringToBytes } from "./secp256k1-DR4_-BNn.js";
import { Nt as formatLog, Xt as estimateFeesPerGas, _n as getAction, d as poll, f as observe, gt as defineChain, hn as readContract, jt as formatTransactionReceipt, kt as getCode, nt as hashTypedData, s as AccountNotFoundError, ut as hashMessage, zt as getChainId } from "./writeContractSync-Kspj32L_.js";
import { D as createClient, L as waitForCallsStatus, T as createPublicClient, bt as createNonceManager, h as http, i as parseSignature, kt as encodePacked, ut as serializeErc6492Signature, z as prepareAuthorization } from "./_esm-hbsOY9FW.js";
import { l as decodeFunctionData } from "./ccip-BCee_EPD.js";
import { o as import_eventemitter3 } from "./createConfig-CGDjXFfS.js";
import { t as p256 } from "./p256-BaV3vt0M.js";
import { g as set, h as get$1, m as del, p as createStore$1 } from "./W3MFrameProviderSingleton-DTtNLwJy.js";
...
function M(n) {
	(!n.__d && (n.__d = !0) && i$1.push(n) && !P.__r++ || o$1 !== l$1.debounceRendering) && ((o$1 = l$1.debounceRendering) || r$1)(P);
}
function P() {
	var n, u, t, o, r, e, c, s;
	for (i$1.sort(f$1); n = i$1.shift();) n.__d && (u = i$1.length, o = void 0, e = (r = (t = n).__v).__e, c = [], s = [], t.__P && ((o = d$1({}, r)).__v = r.__v + 1, l$1.vnode && l$1.vnode(o), O(t.__P, o, r, t.__n, t.__P.namespaceURI, 32 & r.__u ? [e] : null, c, null == e ? x(r) : e, !!(32 & r.__u), s), o.__v = r.__v, o.__.__k[o.__i] = o, j$1(c, o, s), o.__e != e && C$1(o)), i$1.length > u && i$1.sort(f$1));
	P.__r = 0;
}
...
}, k$1.prototype.render = b, i$1 = [], r$1 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$1 = function(n, l) {
...
var Snackbar = class {
	...
	render() {
		if (!this.root) return;
		B$1(_("div", null, _(SnackbarContainer, { darkMode: this.darkMode }, Array.from(this.items.entries()).map(([key, itemProps]) => _(SnackbarInstance, Object.assign({}, itemProps, { key }))))), this.root);
	}
};
...
var sha256$2 = /* @__PURE__ */ createHasher(() => new SHA256$1());
//#endregion
...
async function removeCryptoKey() {
	const keypair = await getKeypair();
	if (!keypair) return;
	await storage$1.removeItem(slice$1(toHex$1(keypair.publicKey), 1));
...
var RedirectDialog = class {
	...
	render(props) {
		...
		B$1(null, this.root);
		if (!props) return;
		B$1(_(RedirectDialogContent, Object.assign({}, props, {
			onDismiss: () => {
				this.clear();
			},
...
var CoinbaseWalletSDK = class {
	constructor(metadata) {
		...
		store.config.set({ metadata: this.metadata });
		checkCrossOriginOpenerPolicy();
	}
	makeWeb3Provider(preference = { options: "all" }) {
		var _a;
		validatePreferences(preference);
		if (preference.telemetry !== false) loadTelemetryScript();
		store.config.set({ preference });
		const params = {
			metadata: this.metadata,
			preference
		};
...
//#endregion
export { CoinbaseWalletSDK, createCoinbaseWalletSDK, dist_default as default, getCryptoKeyAccount, removeCryptoKey };

//# sourceMappingURL=dist-mbe9PIuc.js.map