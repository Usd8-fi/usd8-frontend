import { An as IntegerOutOfRangeError, Ba as toBytes$1, Bi as parseSignature, Bn as padRight, Br as RpcRequestError, Ca as PositionOutOfBoundsError$1, Cn as isAddressEqual, Da as LruMap$1, Dn as erc6492SignatureValidatorByteCode, Do as DecodeLogDataMismatch, Ea as isAddress, Ei as ChainNotFoundError, Eo as BytesSizeMismatchError$1, Fa as rotl, Fn as fromBoolean, Ga as toHex$3, Gn as toNumber$1, Gr as ContractFunctionExecutionError, Ha as bytesToHex, Hn as size$1, Ho as erc1271Abi, In as fromBytes$2, Io as size, Ja as hexToBool, Ji as InvalidAbiParametersError, Jn as validate$4, Jo as multicall3Abi, Ko as erc6492SignatureValidatorAbi, Kr as ContractFunctionRevertedError, La as hexToBytes, Ln as fromNumber, Lo as isHex, Na as createHasher, Nn as concat$1, Oa as keccak256$1, Oi as InvalidChainIdError, On as multicall3Bytecode, Oo as DecodeLogTopicsMismatch, Pi as toEventSelector, Pn as from$8, Po as BaseError, Qn as fromString, Qr as isAbortError, Ri as parseStructs, Rn as fromString$1, Ro as formatAbiItem, Sa as createCursor, Si as parseAccount, Sn as formatBlockParameter, So as AbiEventSignatureNotFoundError, Ta as getAddress, Ti as ChainMismatchError, Ua as numberToHex, Un as slice$1, Vi as splitParameters, Wa as stringToHex, Wr as CallExecutionError, Xn as from$7, Xr as getAbortError, Ya as hexToNumber, Yr as RawContractError, Za as trim, Zn as fromHex$3, aa as formatAbiParameters, ai as TransactionExecutionError, ao as padHex, ar as toString, ci as TransactionReceiptRevertedError, co as InvalidAddressError$1, cr as stringify$1, d as assertRequest, da as concat, dn as FeeCapTooHighError, dt as maxUint256$1, ea as InvalidAbiItemError, ei as InvalidLegacyVError, en as serializeStateOverride, er as size$2, fo as AbiDecodingDataSizeTooSmallError, gr as InvalidInputRpcError, hr as InternalRpcError, ia as formatAbiItem$1, ii as InvalidStorageKeySizeError, in as formatTransactionRequest, ir as toNumber, ja as clean, ji as decodeFunctionResult, jn as InvalidLengthError, ka as keccak_256, ki as encodeFunctionData, l as HashMD, la as bytesRegex$1, li as WaitForTransactionReceiptTimeoutError, ln as getNodeError, lr as BaseError$1, mi as formatEther, na as isStructSignature, ni as InvalidSerializedTransactionError, nn as withResolvers, nr as toBigInt, o as sha256$3, oa as decodeAbiParameters, oi as TransactionNotFoundError, on as defineFormatter, or as trimLeft, pa as concatHex, pi as formatGwei, po as AbiDecodingZeroDataError, qa as hexToBigInt, qn as trimLeft$1, qr as ContractFunctionZeroDataError, ra as modifiers, ri as InvalidSerializedTransactionTypeError, rr as toBoolean, sa as encodeAbiParameters, si as TransactionReceiptNotFoundError, sn as extract$1, sr as validate$5, t as secp256k1, ti as InvalidSerializableTransactionError, to as InvalidHexValueError, tr as slice$2, u as call, ua as integerRegex$1, ui as prettyPrint, wa as checksumAddress, wn as encodeDeployData, xa as sliceHex, xn as UnknownNodeError, xo as AbiEventSignatureEmptyTopicsError, ya as slice, yi as stringify, yn as TipAboveFeeCapError, zi as parseAbiParameter, zn as padLeft } from "./secp256k1-DR4_-BNn.js";
...
async function recoverPublicKey$1({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-DR4_-BNn.js").then((n) => n.n);
	return `0x${(() => {
...
function sha256(value, options = {}) {
	const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
	const bytes = sha256$2(from$7(value));
	if (as === "Bytes") return bytes;
	return fromBytes$2(bytes);
}
/**
...
function verify(options) {
	...
	return secp256k1.verify(options.signature, from$7(payload), toBytes(options.publicKey), ...hash ? [{
		prehash: true,
		lowS: true
	}] : []);
}
...
//#endregion
export { validate$3 as $, getBlock as $t, toRpcList as A, defineTransactionReceipt as At, yParityToV as B, getTransactionError as Bt, unwrap as C, serializeAccessList as Ct, recoverPublicKey as D, parseEventLogs as Dt, recoverAddress as E, assertTransactionLegacy as Et, fromRpc$1 as F, withCache as Ft, checksum as G, commitmentToVersionedHash as Gt, toHex$1 as H, toBlobSidecars as Ht, fromTuple as I, estimateGas as It, validate$2 as J, blobsToCommitments as Jt, fromPublicKey as K, sha256$1 as Kt, toHex as L, prepareTransactionRequest as Lt, extract as M, receiptStatuses as Mt, from$2 as N, formatLog as Nt, verify as O, decodeEventLog as Ot, fromHex as P, getBlockNumber as Pt, sha256 as Q, getGasPrice as Qt, toRpc$1 as R, fillTransaction as Rt, getSerializedTransactionType as S, toYParitySignatureArray as St, wrap$1 as T, assertTransactionEIP2930 as Tt, encode as U, toBlobs as Ut, fromHex$1 as V, getTransactionType as Vt, assert$3 as W, commitmentsToVersionedHashes as Wt, toHex$2 as X, estimateFeesPerGas as Xt, fromHex$2 as Y, getTransactionCount as Yt, keccak256 as Z, estimateMaxPriorityFeePerGas as Zt, fromAbi as _, getAction as _n, extendSchema as _t, sendTransaction as a, BlockNotFoundError as an, serializeTypedData as at, getTransaction as b, wait as bt, AccountTypeNotSupportedError as c, MaxFeePerGasTooLowError as cn, InvalidPrimaryTypeError as ct, poll as d, hexToRlp as dn, toPrefixedMessage as dt, defineBlock as en, hashDomain as et, observe as f, toRlp as fn, presignMessagePrefix as ft, from as g, getContractError as gn, defineChain as gt, NotFoundError as h, readContract as hn, fromRlp as ht, sendRawTransactionSync as i, transactionType as in, getTypesForEIP712Domain as it, assert$2 as j, formatTransactionReceipt as jt, fromRpcList as k, getCode as kt, waitForTransactionReceipt as l, EstimateGasExecutionError as ln, InvalidStructTypeError as lt, serializeSignature as m, recoverPublicKey$1 as mn, isHash as mt, writeContract as n, defineTransaction as nn, hashTypedData as nt, sendRawTransaction as o, BaseFeeScalarError as on, validateTypedData as ot, verifyHash as p, recoverAddress$1 as pn, ripemd160 as pt, isEqual as q, blobsToProofs as qt, sendTransactionSync as r, formatTransaction as rn, domainSeparator as rt, AccountNotFoundError as s, Eip1559FeesNotSupportedError as sn, InvalidDomainError as st, writeContractSync as t, formatBlock as tn, hashStruct as tt, watchBlockNumber as u, bytesToRlp as un, hashMessage as ut, getSelector as v, parseAbiParameters as vn, assertCurrentChain as vt, validate$1 as w, assertTransactionEIP1559 as wt, parseTransaction as x, serializeTransaction as xt, getTransactionReceipt as y, parseAbiItem as yn, withRetry as yt, toTuple$1 as z, getChainId as zt };

//# sourceMappingURL=writeContractSync-Kspj32L_.js.map