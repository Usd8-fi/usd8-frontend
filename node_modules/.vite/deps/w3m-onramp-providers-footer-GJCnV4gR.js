import { M as OptionsController, V as W3mFrameRpcConstants, b as RouterController, g as getPreferredAccountType, r as ChainController, w as EventsController } from "./ModalController-D0mbRgVR.js";
import { _ as css, f as elementStyles, l as customElement, m as resetStyles, s as state, w as css$1, x as html, y as LitElement } from "./wui-text-CswcyjL8.js";
...
WuiUxByReown = __decorate$2([customElement("wui-ux-by-reown")], WuiUxByReown);
//#endregion
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-legal-footer/index.js
...
var W3mLegalFooter = class W3mLegalFooter extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
	...
	render() {
		...
		if (!termsConditionsUrl && !privacyPolicyUrl || legalCheckbox) return html`
	...
	reownBrandingTemplate(showOnlyBranding = false) {
		...
		if (showOnlyBranding) return html`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`;
		return html`<wui-ux-by-reown></wui-ux-by-reown>`;
	}
};
W3mLegalFooter.styles = [styles_default$1];
__decorate$1([state()], W3mLegalFooter.prototype, "remoteFeatures", void 0);
W3mLegalFooter = __decorate$1([customElement("w3m-legal-footer")], W3mLegalFooter);
//#endregion
...
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-onramp-providers-footer/index.js
...
var W3mOnRampProvidersFooter = class W3mOnRampProvidersFooter extends LitElement {
	render() {
		const { termsConditionsUrl, privacyPolicyUrl } = OptionsController.state;
...
W3mOnRampProvidersFooter = __decorate([customElement("w3m-onramp-providers-footer")], W3mOnRampProvidersFooter);
//#endregion

//# sourceMappingURL=w3m-onramp-providers-footer-GJCnV4gR.js.map