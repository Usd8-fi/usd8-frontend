import { E as AssetUtil, H as CoreHelperUtil, b as RouterController, j as SnackController, l as ConnectionController, r as ChainController } from "./ModalController-D0mbRgVR.js";
import { _ as css, c as property, f as elementStyles, l as customElement, m as resetStyles, o as ifDefined, s as state, x as html, y as LitElement } from "./wui-text-CswcyjL8.js";
import { t as ExchangeController } from "./ExchangeController-MxZMZyzO.js";
...
__decorate$3([property()], WuiChipButton.prototype, "type", void 0);
__decorate$3([property()], WuiChipButton.prototype, "size", void 0);
__decorate$3([property()], WuiChipButton.prototype, "imageSrc", void 0);
__decorate$3([property({ type: Boolean })], WuiChipButton.prototype, "disabled", void 0);
__decorate$3([property()], WuiChipButton.prototype, "leftIcon", void 0);
__decorate$3([property()], WuiChipButton.prototype, "rightIcon", void 0);
__decorate$3([property()], WuiChipButton.prototype, "text", void 0);
WuiChipButton = __decorate$3([customElement("wui-chip-button")], WuiChipButton);
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/partials/w3m-fund-input/index.js
...
var W3mFundInput = class W3mFundInput extends LitElement {
	constructor() {
		super(...arguments);
...
__decorate$2([property({ type: Number })], W3mFundInput.prototype, "amount", void 0);
__decorate$2([property({ type: Number })], W3mFundInput.prototype, "maxDecimals", void 0);
__decorate$2([property({ type: Number })], W3mFundInput.prototype, "maxIntegers", void 0);
W3mFundInput = __decorate$2([customElement("w3m-fund-input")], W3mFundInput);
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-deposit-from-exchange-view/styles.js
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-deposit-from-exchange-view/index.js
...
var MAX_DECIMALS = 6;
var MAX_INTEGERS = 10;
var W3mDepositFromExchangeView = class W3mDepositFromExchangeView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		...
		this.unsubscribe.push(ChainController.subscribeKey("activeCaipNetwork", (val) => {
			...
			if (exchangeState.isPaymentInProgress && exchangeState.currentPayment?.exchangeId && exchangeState.currentPayment?.sessionId && exchangeState.paymentId) this.handlePaymentInProgress();
		}));
	}
	disconnectedCallback() {
		this.unsubscribe.forEach((unsubscribe) => unsubscribe());
		if (!ExchangeController.state.isPaymentInProgress) ExchangeController.reset();
	}
	async firstUpdated() {
		await this.getPaymentAssets();
		if (!this.paymentAsset) await this.setDefaultPaymentAsset();
	...
	tokenAmountTemplate() {
		if (this.priceLoading) return html`<wui-shimmer
        width="65px"
        height="20px"
        borderRadius="xxs"
        variant="light"
	...
	handlePaymentInProgress() {
		...
		if (this.isPaymentInProgress && this.currentPayment?.exchangeId && this.currentPayment?.sessionId && this.paymentId) {
			ExchangeController.waitUntilComplete({
				...
				} else if (status.status === "FAILED") SnackController.showError("Deposit failed");
			});
	...
	async getPaymentAssets() {
		if (this.network) await ExchangeController.getAssetsForNetwork(this.network.caipNetworkId);
	}
	async setDefaultPaymentAsset() {
		if (this.network) {
			const paymentAssets = await ExchangeController.getAssetsForNetwork(this.network.caipNetworkId);
			if (paymentAssets[0]) ExchangeController.setPaymentAsset(paymentAssets[0]);
		}
	}
};
W3mDepositFromExchangeView.styles = styles_default$1;
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "network", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "exchanges", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "isLoading", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "amount", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "tokenAmount", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "priceLoading", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "isPaymentInProgress", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "currentPayment", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "paymentId", void 0);
__decorate$1([state()], W3mDepositFromExchangeView.prototype, "paymentAsset", void 0);
W3mDepositFromExchangeView = __decorate$1([customElement("w3m-deposit-from-exchange-view")], W3mDepositFromExchangeView);
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-deposit-from-exchange-select-asset-view/styles.js
...
`;
//#endregion
//#region node_modules/@reown/appkit-scaffold-ui/dist/esm/src/views/w3m-deposit-from-exchange-select-asset-view/index.js
...
var W3mDepositFromExchangeSelectAssetView = class W3mDepositFromExchangeSelectAssetView extends LitElement {
	constructor() {
		super();
		this.unsubscribe = [];
		...
		this.unsubscribe.push(...[ExchangeController.subscribe((val) => {
	...
	templateTokens() {
      ...
      >
        ...
        <wui-flex flexDirection="column" gap="2">
          ${filteredAssets.length > 0 ? filteredAssets.map((asset) => html`<wui-list-item
...
W3mDepositFromExchangeSelectAssetView.styles = styles_default;
__decorate([state()], W3mDepositFromExchangeSelectAssetView.prototype, "assets", void 0);
__decorate([state()], W3mDepositFromExchangeSelectAssetView.prototype, "search", void 0);
W3mDepositFromExchangeSelectAssetView = __decorate([customElement("w3m-deposit-from-exchange-select-asset-view")], W3mDepositFromExchangeSelectAssetView);
//#endregion
export { W3mDepositFromExchangeSelectAssetView, W3mDepositFromExchangeView };

//# sourceMappingURL=pay-with-exchange-BBWQBv4s.js.map