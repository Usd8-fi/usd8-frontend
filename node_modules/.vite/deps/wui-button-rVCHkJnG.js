...
var WuiButton = class WuiButton extends LitElement {
	...
	loadingTemplate() {
		if (this.loading) {
			...
			return html`<wui-loading-spinner color=${this.variant === "neutral-primary" || this.variant === "accent-primary" ? "invert" : "primary"} size=${size}></wui-loading-spinner>`;
		}
		return null;
	}
};
...
__decorate([property({ type: Boolean })], WuiButton.prototype, "disabled", void 0);
__decorate([property({ type: Boolean })], WuiButton.prototype, "fullWidth", void 0);
__decorate([property({ type: Boolean })], WuiButton.prototype, "loading", void 0);
...
//# sourceMappingURL=wui-button-rVCHkJnG.js.map