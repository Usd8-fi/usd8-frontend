...
var WuiInputText = class WuiInputText extends LitElement {
	...
	templateSubmitButton() {
		if (this.onSubmit) return html`<button
	...
	templateError() {
		if (this.errorText) return html`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`;
		return null;
	}
	templateWarning() {
		if (this.warningText) return html`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`;
		return null;
	}
...
__decorate([property({ type: Boolean })], WuiInputText.prototype, "disabled", void 0);
__decorate([property({ type: Boolean })], WuiInputText.prototype, "loading", void 0);
...
__decorate([property()], WuiInputText.prototype, "errorText", void 0);
__decorate([property()], WuiInputText.prototype, "warningText", void 0);
__decorate([property()], WuiInputText.prototype, "onSubmit", void 0);
__decorate([property()], WuiInputText.prototype, "size", void 0);
__decorate([property({ attribute: false })], WuiInputText.prototype, "onKeyDown", void 0);
WuiInputText = __decorate([customElement("wui-input-text")], WuiInputText);
//#endregion

//# sourceMappingURL=wui-input-text-DAmxIVqv.js.map